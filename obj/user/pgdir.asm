...
main(void) {
  ...
  801a42:	c7 04 24 00 1f 80 00 	movl   $0x801f00,(%esp)
  801a49:	e8 e9 e9 ff ff       	call   800437 <cprintf>
    print_pgdir();
  801a4e:	e8 b5 f0 ff ff       	call   800b08 <print_pgdir>
    cprintf("pgdir pass.\n");
  801a53:	c7 04 24 17 1f 80 00 	movl   $0x801f17,(%esp)
  801a5a:	e8 d8 e9 ff ff       	call   800437 <cprintf>
    return 0;
