...
obj/__user_ccd.out：     文件格式 elf32-i386
...
int main(void)
{
  ...
  801a36:	81 ec 20 02 00 00    	sub    $0x220,%esp
	char s[256], *sp = &s;
  801a3c:	8d 84 24 14 01 00 00 	lea    0x114(%esp),%eax
  801a43:	89 84 24 1c 02 00 00 	mov    %eax,0x21c(%esp)
	char news[256], *newsp = &news;
  801a4a:	8d 44 24 14          	lea    0x14(%esp),%eax
  801a4e:	89 84 24 18 02 00 00 	mov    %eax,0x218(%esp)

	getcwd(sp, 256);
  801a55:	c7 44 24 04 00 01 00 	movl   $0x100,0x4(%esp)
  801a5c:	00 
  801a5d:	8b 84 24 1c 02 00 00 	mov    0x21c(%esp),%eax
  801a64:	89 04 24             	mov    %eax,(%esp)
  801a67:	e8 85 e6 ff ff       	call   8000f1 <getcwd>
	printf("dir name : %s\n", sp);
  801a6c:	8b 84 24 1c 02 00 00 	mov    0x21c(%esp),%eax
  801a73:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a77:	c7 44 24 04 80 1f 80 	movl   $0x801f80,0x4(%esp)
  801a7e:	00 
  801a7f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a86:	e8 90 ea ff ff       	call   80051b <fprintf>

	int ret = chcwd("test_dir");
  801a8b:	c7 04 24 8f 1f 80 00 	movl   $0x801f8f,(%esp)
  801a92:	e8 74 e6 ff ff       	call   80010b <chcwd>
  801a97:	89 84 24 14 02 00 00 	mov    %eax,0x214(%esp)
	printf("ret = %d\n", ret);
  801a9e:	8b 84 24 14 02 00 00 	mov    0x214(%esp),%eax
  801aa5:	89 44 24 08          	mov    %eax,0x8(%esp)
  801aa9:	c7 44 24 04 98 1f 80 	movl   $0x801f98,0x4(%esp)
  801ab0:	00 
  801ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ab8:	e8 5e ea ff ff       	call   80051b <fprintf>

	getcwd(newsp, 256);
  801abd:	c7 44 24 04 00 01 00 	movl   $0x100,0x4(%esp)
  801ac4:	00 
  801ac5:	8b 84 24 18 02 00 00 	mov    0x218(%esp),%eax
  801acc:	89 04 24             	mov    %eax,(%esp)
  801acf:	e8 1d e6 ff ff       	call   8000f1 <getcwd>
	printf("new dir name : %s\n", newsp);
  801ad4:	8b 84 24 18 02 00 00 	mov    0x218(%esp),%eax
  801adb:	89 44 24 08          	mov    %eax,0x8(%esp)
  801adf:	c7 44 24 04 a2 1f 80 	movl   $0x801fa2,0x4(%esp)
  801ae6:	00 
  801ae7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801aee:	e8 28 ea ff ff       	call   80051b <fprintf>
