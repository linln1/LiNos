...
obj/__user_looptest.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 00 1d 80 00 	movl   $0x801d00,(%esp)
  ...
  8002de:	c7 04 24 0b 1d 80 00 	movl   $0x801d0b,(%esp)
  ...
  8002f4:	c7 04 24 1d 1d 80 00 	movl   $0x801d1d,(%esp)
  ...
  80030a:	c7 04 24 30 1d 80 00 	movl   $0x801d30,(%esp)
  ...
  800320:	c7 04 24 43 1d 80 00 	movl   $0x801d43,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 56 1d 80 00 	movl   $0x801d56,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 70 1d 80 00 	movl   $0x801d70,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 72 1d 80 00 	movl   $0x801d72,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 70 1d 80 00 	movl   $0x801d70,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 8e 1d 80 00 	movl   $0x801d8e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 a1 1d 80 	movl   $0x801da1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 a8 1d 80 	movl   $0x801da8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 c2 1d 80 00 	movl   $0x801dc2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 d4 1d 80 	movl   $0x801dd4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 dc 1d 80 	movl   $0x801ddc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 c2 1d 80 00 	movl   $0x801dc2,(%esp)
  ...
  800d3a:	e8 5d 0f 00 00       	call   801c9c <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 04 20 80 00       	add    $0x802004,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 28 20 80 00 	mov    0x802028(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 1e 20 80 	movl   $0x80201e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 21 20 80 00       	mov    $0x802021,%esi
            }
            if (width > 0 && padc != '-') {
...
gettoken(char **p1, char **p2) {
  ...
  801a69:	c7 04 24 80 21 80 00 	movl   $0x802180,(%esp)
  ...
  801aa9:	c7 04 24 85 21 80 00 	movl   $0x802185,(%esp)
  ...
  801b1a:	c7 04 24 8b 21 80 00 	movl   $0x80218b,(%esp)
...
readline(const char *prompt) {
  ...
  801b5b:	c7 44 24 04 95 21 80 	movl   $0x802195,0x4(%esp)
  801b62:	00 
  ...
  801bf8:	c7 44 24 04 99 21 80 	movl   $0x802199,0x4(%esp)
  801bff:	00 
  ...
  801c3a:	c7 44 24 04 99 21 80 	movl   $0x802199,0x4(%esp)
  801c41:	00 
  ...
  801c6f:	c7 44 24 04 99 21 80 	movl   $0x802199,0x4(%esp)
  801c76:	00 
...
int main(){
  ...
  801c9f:	83 e4 f0             	and    $0xfffffff0,%esp
  801ca2:	83 ec 20             	sub    $0x20,%esp
	char *buffer;
	printf("1\n");
  801ca5:	c7 44 24 04 9c 21 80 	movl   $0x80219c,0x4(%esp)
  801cac:	00 
  801cad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cb4:	e8 62 e8 ff ff       	call   80051b <fprintf>
	while((buffer = readline((1) ? "U> " : NULL)) != NULL){
  801cb9:	eb 14                	jmp    801ccf <main+0x33>
		printf("\n2\n");
  801cbb:	c7 44 24 04 9f 21 80 	movl   $0x80219f,0x4(%esp)
  801cc2:	00 
  801cc3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cca:	e8 4c e8 ff ff       	call   80051b <fprintf>
}
...
int main(){
	...
	printf("1\n");
	while((buffer = readline((1) ? "U> " : NULL)) != NULL){
  801ccf:	c7 04 24 a3 21 80 00 	movl   $0x8021a3,(%esp)
  801cd6:	e8 6d fe ff ff       	call   801b48 <readline>
  801cdb:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801cdf:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801ce4:	75 d5                	jne    801cbb <main+0x1f>
		printf("\n2\n");
	}
}
  801ce6:	c9                   	leave  
