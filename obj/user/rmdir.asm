...
obj/__user_rmdir.out：     文件格式 elf32-i386
...
int main(int argc, char** argv)
{
  ...
  801a3d:	74 14                	je     801a53 <main+0x23>
  ...
  801a56:	83 c0 04             	add    $0x4,%eax
  801a59:	8b 00                	mov    (%eax),%eax
  801a5b:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  801a62:	00 
  801a63:	89 04 24             	mov    %eax,(%esp)
  801a66:	e8 cd e6 ff ff       	call   800138 <delete>
  801a6b:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	if(ret == 0) {
  801a6f:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a74:	75 20                	jne    801a96 <main+0x66>
		printf("dir %s deleted successful!\n", argv[1]);
  801a76:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a79:	83 c0 04             	add    $0x4,%eax
  801a7c:	8b 00                	mov    (%eax),%eax
  801a7e:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a82:	c7 44 24 04 44 1f 80 	movl   $0x801f44,0x4(%esp)
  801a89:	00 
  801a8a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a91:	e8 85 ea ff ff       	call   80051b <fprintf>
	}
