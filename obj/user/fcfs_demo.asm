...
obj/__user_fcfs_demo.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 e0 1b 80 00 	movl   $0x801be0,(%esp)
  ...
  8002de:	c7 04 24 eb 1b 80 00 	movl   $0x801beb,(%esp)
  ...
  8002f4:	c7 04 24 fd 1b 80 00 	movl   $0x801bfd,(%esp)
  ...
  80030a:	c7 04 24 10 1c 80 00 	movl   $0x801c10,(%esp)
  ...
  800320:	c7 04 24 23 1c 80 00 	movl   $0x801c23,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 36 1c 80 00 	movl   $0x801c36,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 50 1c 80 00 	movl   $0x801c50,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 52 1c 80 00 	movl   $0x801c52,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 50 1c 80 00 	movl   $0x801c50,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 6e 1c 80 00 	movl   $0x801c6e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 81 1c 80 	movl   $0x801c81,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 88 1c 80 	movl   $0x801c88,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 a2 1c 80 00 	movl   $0x801ca2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 b4 1c 80 	movl   $0x801cb4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 bc 1c 80 	movl   $0x801cbc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 a2 1c 80 00 	movl   $0x801ca2,(%esp)
  ...
  800d3a:	e8 a0 0d 00 00       	call   801adf <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 e4 1e 80 00       	add    $0x801ee4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 08 1f 80 00 	mov    0x801f08(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c fe 1e 80 	movl   $0x801efe,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 01 1f 80 00       	mov    $0x801f01,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  801a33:	83 ec 08             	sub    $0x8,%esp
    yield();
  801a36:	e8 a0 f0 ff ff       	call   800adb <yield>
    yield();
  801a3b:	e8 9b f0 ff ff       	call   800adb <yield>
    yield();
  801a40:	e8 96 f0 ff ff       	call   800adb <yield>
    yield();
  801a45:	e8 91 f0 ff ff       	call   800adb <yield>
    yield();
  801a4a:	e8 8c f0 ff ff       	call   800adb <yield>
    yield();
  801a4f:	e8 87 f0 ff ff       	call   800adb <yield>
}
  801a54:	c9                   	leave  
  801a55:	c3                   	ret    
...
loop(void) {
  ...
  801a59:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  801a5c:	c7 04 24 60 20 80 00 	movl   $0x802060,(%esp)
  801a63:	e8 cf e9 ff ff       	call   800437 <cprintf>
    while (1){
	cprintf("nop...\n");
  801a68:	c7 04 24 6a 20 80 00 	movl   $0x80206a,(%esp)
  801a6f:	e8 c3 e9 ff ff       	call   800437 <cprintf>
    }
  801a74:	eb f2                	jmp    801a68 <loop+0x12>
...
work(void) {
  ...
  801a79:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  801a7c:	c7 04 24 72 20 80 00 	movl   $0x802072,(%esp)
  801a83:	e8 af e9 ff ff       	call   800437 <cprintf>
    do_yield();
  801a88:	e8 a3 ff ff ff       	call   801a30 <do_yield>
    if (kill(parent) == 0) {
  801a8d:	a1 48 31 80 00       	mov    0x803148,%eax
  801a92:	89 04 24             	mov    %eax,(%esp)
  801a95:	e8 4e f0 ff ff       	call   800ae8 <kill>
  801a9a:	85 c0                	test   %eax,%eax
  801a9c:	75 35                	jne    801ad3 <work+0x5d>
        cprintf("kill parent ok.\n");
  801a9e:	c7 04 24 7c 20 80 00 	movl   $0x80207c,(%esp)
  801aa5:	e8 8d e9 ff ff       	call   800437 <cprintf>
        //do_yield();
        if (kill(pid1) == 0) {
  801aaa:	a1 50 31 80 00       	mov    0x803150,%eax
  801aaf:	89 04 24             	mov    %eax,(%esp)
  801ab2:	e8 31 f0 ff ff       	call   800ae8 <kill>
  801ab7:	85 c0                	test   %eax,%eax
  801ab9:	75 18                	jne    801ad3 <work+0x5d>
            cprintf("kill child1 ok.\n");
  801abb:	c7 04 24 8d 20 80 00 	movl   $0x80208d,(%esp)
  801ac2:	e8 70 e9 ff ff       	call   800437 <cprintf>
            exit(0);
  801ac7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801ace:	e8 a6 ef ff ff       	call   800a79 <exit>
        }
    }
    exit(-1);
  801ad3:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801ada:	e8 9a ef ff ff       	call   800a79 <exit>
...
main(void) {
  ...
  801ae2:	83 e4 f0             	and    $0xfffffff0,%esp
  801ae5:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801ae8:	e8 0e f0 ff ff       	call   800afb <getpid>
  801aed:	a3 48 31 80 00       	mov    %eax,0x803148
    cprintf("parent pid: %d \n", parent);
  801af2:	a1 48 31 80 00       	mov    0x803148,%eax
  801af7:	89 44 24 04          	mov    %eax,0x4(%esp)
  801afb:	c7 04 24 9e 20 80 00 	movl   $0x80209e,(%esp)
  801b02:	e8 30 e9 ff ff       	call   800437 <cprintf>
    if ((pid1 = fork()) == 0) {
  801b07:	e8 8c ef ff ff       	call   800a98 <fork>
  801b0c:	a3 50 31 80 00       	mov    %eax,0x803150
  801b11:	a1 50 31 80 00       	mov    0x803150,%eax
  801b16:	85 c0                	test   %eax,%eax
  801b18:	75 05                	jne    801b1f <main+0x40>
        loop();
  801b1a:	e8 37 ff ff ff       	call   801a56 <loop>
    }

    assert(pid1 > 0);
  801b1f:	a1 50 31 80 00       	mov    0x803150,%eax
  801b24:	85 c0                	test   %eax,%eax
  801b26:	7f 24                	jg     801b4c <main+0x6d>
  801b28:	c7 44 24 0c af 20 80 	movl   $0x8020af,0xc(%esp)
  801b2f:	00 
  801b30:	c7 44 24 08 b8 20 80 	movl   $0x8020b8,0x8(%esp)
  801b37:	00 
  801b38:	c7 44 24 04 2f 00 00 	movl   $0x2f,0x4(%esp)
  801b3f:	00 
  801b40:	c7 04 24 cd 20 80 00 	movl   $0x8020cd,(%esp)
  801b47:	e8 fa e7 ff ff       	call   800346 <__panic>

    if ((pid2 = fork()) == 0) {
  801b4c:	e8 47 ef ff ff       	call   800a98 <fork>
  801b51:	a3 4c 31 80 00       	mov    %eax,0x80314c
  801b56:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801b5b:	85 c0                	test   %eax,%eax
  801b5d:	75 05                	jne    801b64 <main+0x85>
        work();
  801b5f:	e8 12 ff ff ff       	call   801a76 <work>
    }
    if (pid2 > 0) {
  801b64:	a1 4c 31 80 00       	mov    0x80314c,%eax
  801b69:	85 c0                	test   %eax,%eax
  801b6b:	7e 46                	jle    801bb3 <main+0xd4>
        cprintf("wait child 1.\n");
  801b6d:	c7 04 24 de 20 80 00 	movl   $0x8020de,(%esp)
  801b74:	e8 be e8 ff ff       	call   800437 <cprintf>
        waitpid(pid1, NULL);
  801b79:	a1 50 31 80 00       	mov    0x803150,%eax
  801b7e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801b85:	00 
  801b86:	89 04 24             	mov    %eax,(%esp)
  801b89:	e8 33 ef ff ff       	call   800ac1 <waitpid>
        panic("waitpid %d returns\n", pid1);
  801b8e:	a1 50 31 80 00       	mov    0x803150,%eax
  801b93:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801b97:	c7 44 24 08 ed 20 80 	movl   $0x8020ed,0x8(%esp)
  801b9e:	00 
  801b9f:	c7 44 24 04 37 00 00 	movl   $0x37,0x4(%esp)
  801ba6:	00 
  801ba7:	c7 04 24 cd 20 80 00 	movl   $0x8020cd,(%esp)
  801bae:	e8 93 e7 ff ff       	call   800346 <__panic>
    }
    else {
        kill(pid1);
  801bb3:	a1 50 31 80 00       	mov    0x803150,%eax
  801bb8:	89 04 24             	mov    %eax,(%esp)
  801bbb:	e8 28 ef ff ff       	call   800ae8 <kill>
    }
    panic("FAIL: T.T\n");
  801bc0:	c7 44 24 08 01 21 80 	movl   $0x802101,0x8(%esp)
  801bc7:	00 
  801bc8:	c7 44 24 04 3c 00 00 	movl   $0x3c,0x4(%esp)
  801bcf:	00 
  801bd0:	c7 04 24 cd 20 80 00 	movl   $0x8020cd,(%esp)
  801bd7:	e8 6a e7 ff ff       	call   800346 <__panic>
