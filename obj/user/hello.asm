...
main(void) {
  ...
  801a36:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  801a39:	c7 04 24 00 1f 80 00 	movl   $0x801f00,(%esp)
  801a40:	e8 f2 e9 ff ff       	call   800437 <cprintf>
    cprintf("I am process %d.\n", getpid());
  801a45:	e8 b1 f0 ff ff       	call   800afb <getpid>
  801a4a:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a4e:	c7 04 24 10 1f 80 00 	movl   $0x801f10,(%esp)
  801a55:	e8 dd e9 ff ff       	call   800437 <cprintf>
    cprintf("hello pass.\n");
  801a5a:	c7 04 24 22 1f 80 00 	movl   $0x801f22,(%esp)
  801a61:	e8 d1 e9 ff ff       	call   800437 <cprintf>
    return 0;
