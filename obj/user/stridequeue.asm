...
obj/__user_stridequeue.out：     文件格式 elf32-i386
...
main(void)
{
  ...
  801a4c:	00 
  801a4d:	eb 45                	jmp    801a94 <main+0x64>
    {
  ...
  801a5d:	75 30                	jne    801a8f <main+0x5f>
    	{
  ...
  801a7b:	00 
    	    while(i<MAX_TICKS){
  801a7c:	eb 05                	jmp    801a83 <main+0x53>
		i++;
  801a7e:	83 44 24 18 01       	addl   $0x1,0x18(%esp)
	    ...
	    int i=0;
    	    while(i<MAX_TICKS){
  801a83:	81 7c 24 18 ff e0 f5 	cmpl   $0x5f5e0ff,0x18(%esp)
  801a8a:	05 
  801a8b:	7e f1                	jle    801a7e <main+0x4e>
		i++;
	    }
	    break;
  801a8d:	eb 0c                	jmp    801a9b <main+0x6b>
int 
main(void)
{
    int i,j,pid;
    lab6_set_priority(60000000);
    for(i=0;i<5;i++)
  801a8f:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a94:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a99:	7e b4                	jle    801a4f <main+0x1f>
	    }
	    break;
	    }
