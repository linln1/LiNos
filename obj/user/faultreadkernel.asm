...
main(void) {
  ...
  801a39:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  801a3e:	8b 00                	mov    (%eax),%eax
  801a40:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a44:	c7 04 24 00 1f 80 00 	movl   $0x801f00,(%esp)
  801a4b:	e8 e7 e9 ff ff       	call   800437 <cprintf>
    panic("FAIL: T.T\n");
  801a50:	c7 44 24 08 1e 1f 80 	movl   $0x801f1e,0x8(%esp)
  801a57:	00 
  801a58:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801a5f:	00 
  801a60:	c7 04 24 29 1f 80 00 	movl   $0x801f29,(%esp)
  801a67:	e8 da e8 ff ff       	call   800346 <__panic>
