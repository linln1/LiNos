...
obj/__user_ps.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 80 1a 80 00 	movl   $0x801a80,(%esp)
  ...
  8002de:	c7 04 24 8b 1a 80 00 	movl   $0x801a8b,(%esp)
  ...
  8002f4:	c7 04 24 9d 1a 80 00 	movl   $0x801a9d,(%esp)
  ...
  80030a:	c7 04 24 b0 1a 80 00 	movl   $0x801ab0,(%esp)
  ...
  800320:	c7 04 24 c3 1a 80 00 	movl   $0x801ac3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 d6 1a 80 00 	movl   $0x801ad6,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 f0 1a 80 00 	movl   $0x801af0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 f2 1a 80 00 	movl   $0x801af2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 f0 1a 80 00 	movl   $0x801af0,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 0e 1b 80 00 	movl   $0x801b0e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 21 1b 80 	movl   $0x801b21,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 28 1b 80 	movl   $0x801b28,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 42 1b 80 00 	movl   $0x801b42,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 54 1b 80 	movl   $0x801b54,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 5c 1b 80 	movl   $0x801b5c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 42 1b 80 00 	movl   $0x801b42,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 84 1d 80 00       	add    $0x801d84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 a8 1d 80 00 	mov    0x801da8(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 9e 1d 80 	movl   $0x801d9e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be a1 1d 80 00       	mov    $0x801da1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801a45:	75 0e                	jne    801a55 <main+0x25>
    {
     cprintf(" ");
  801a47:	c7 04 24 00 1f 80 00 	movl   $0x801f00,(%esp)
  801a4e:	e8 e4 e9 ff ff       	call   800437 <cprintf>
  801a53:	eb 16                	jmp    801a6b <main+0x3b>
    }else
    {cprintf("------\n");
  801a55:	c7 04 24 02 1f 80 00 	movl   $0x801f02,(%esp)
  801a5c:	e8 d6 e9 ff ff       	call   800437 <cprintf>
    listProc();
  801a61:	e8 45 f1 ff ff       	call   800bab <listProc>
    
    listProc();
  801a66:	e8 40 f1 ff ff       	call   800bab <listProc>
