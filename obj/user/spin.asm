...
main(void) {
  ...
  801a39:	c7 04 24 00 20 80 00 	movl   $0x802000,(%esp)
  ...
  801a53:	75 0e                	jne    801a63 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  801a55:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  801a5c:	e8 d6 e9 ff ff       	call   800437 <cprintf>
        while (1);
  801a61:	eb fe                	jmp    801a61 <main+0x31>
    }else if (pid<0) {
  801a63:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a68:	79 1c                	jns    801a86 <main+0x56>
        panic("fork child error\n");
  801a6a:	c7 44 24 08 45 20 80 	movl   $0x802045,0x8(%esp)
  801a71:	00 
  801a72:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  801a79:	00 
  801a7a:	c7 04 24 57 20 80 00 	movl   $0x802057,(%esp)
  801a81:	e8 c0 e8 ff ff       	call   800346 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  801a86:	c7 04 24 64 20 80 00 	movl   $0x802064,(%esp)
  801a8d:	e8 a5 e9 ff ff       	call   800437 <cprintf>

    yield();
  801a92:	e8 44 f0 ff ff       	call   800adb <yield>
    yield();
  801a97:	e8 3f f0 ff ff       	call   800adb <yield>
    yield();
  801a9c:	e8 3a f0 ff ff       	call   800adb <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  801aa1:	c7 04 24 8c 20 80 00 	movl   $0x80208c,(%esp)
  801aa8:	e8 8a e9 ff ff       	call   800437 <cprintf>

    assert((ret = kill(pid)) == 0);
  801aad:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ab1:	89 04 24             	mov    %eax,(%esp)
  801ab4:	e8 2f f0 ff ff       	call   800ae8 <kill>
  801ab9:	89 44 24 18          	mov    %eax,0x18(%esp)
  801abd:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801ac2:	74 24                	je     801ae8 <main+0xb8>
  801ac4:	c7 44 24 0c b4 20 80 	movl   $0x8020b4,0xc(%esp)
  801acb:	00 
  801acc:	c7 44 24 08 cb 20 80 	movl   $0x8020cb,0x8(%esp)
  801ad3:	00 
  801ad4:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801adb:	00 
  801adc:	c7 04 24 57 20 80 00 	movl   $0x802057,(%esp)
  801ae3:	e8 5e e8 ff ff       	call   800346 <__panic>
    cprintf("kill returns %d\n", ret);
  801ae8:	8b 44 24 18          	mov    0x18(%esp),%eax
  801aec:	89 44 24 04          	mov    %eax,0x4(%esp)
  801af0:	c7 04 24 e0 20 80 00 	movl   $0x8020e0,(%esp)
  801af7:	e8 3b e9 ff ff       	call   800437 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  801afc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801b03:	00 
  801b04:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b08:	89 04 24             	mov    %eax,(%esp)
  801b0b:	e8 b1 ef ff ff       	call   800ac1 <waitpid>
  801b10:	89 44 24 18          	mov    %eax,0x18(%esp)
  801b14:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801b19:	74 24                	je     801b3f <main+0x10f>
  801b1b:	c7 44 24 0c f4 20 80 	movl   $0x8020f4,0xc(%esp)
  801b22:	00 
  801b23:	c7 44 24 08 cb 20 80 	movl   $0x8020cb,0x8(%esp)
  801b2a:	00 
  801b2b:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  801b32:	00 
  801b33:	c7 04 24 57 20 80 00 	movl   $0x802057,(%esp)
  801b3a:	e8 07 e8 ff ff       	call   800346 <__panic>
    cprintf("wait returns %d\n", ret);
  801b3f:	8b 44 24 18          	mov    0x18(%esp),%eax
  801b43:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b47:	c7 04 24 14 21 80 00 	movl   $0x802114,(%esp)
  801b4e:	e8 e4 e8 ff ff       	call   800437 <cprintf>

    cprintf("spin may pass.\n");
  801b53:	c7 04 24 25 21 80 00 	movl   $0x802125,(%esp)
  801b5a:	e8 d8 e8 ff ff       	call   800437 <cprintf>
    return 0;
