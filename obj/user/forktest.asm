...
main(void) {
  ...
  801a39:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a40:	00 
  801a41:	eb 60                	jmp    801aa3 <main+0x73>
        if ((pid = fork()) == 0) {
  801a43:	e8 50 f0 ff ff       	call   800a98 <fork>
  801a48:	89 44 24 18          	mov    %eax,0x18(%esp)
  801a4c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801a51:	75 20                	jne    801a73 <main+0x43>
            cprintf("I am child %d\n", n);
  801a53:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a57:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a5b:	c7 04 24 e4 1f 80 00 	movl   $0x801fe4,(%esp)
  801a62:	e8 d0 e9 ff ff       	call   800437 <cprintf>
            exit(0);
  801a67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801a6e:	e8 06 f0 ff ff       	call   800a79 <exit>
        }
        assert(pid > 0);
  801a73:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801a78:	7f 24                	jg     801a9e <main+0x6e>
  801a7a:	c7 44 24 0c f3 1f 80 	movl   $0x801ff3,0xc(%esp)
  801a81:	00 
  801a82:	c7 44 24 08 fb 1f 80 	movl   $0x801ffb,0x8(%esp)
  801a89:	00 
  801a8a:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801a91:	00 
  801a92:	c7 04 24 10 20 80 00 	movl   $0x802010,(%esp)
  801a99:	e8 a8 e8 ff ff       	call   800346 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  801a9e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801aa3:	b8 20 00 00 00       	mov    $0x20,%eax
  801aa8:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801aac:	7c 95                	jl     801a43 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  801aae:	b8 20 00 00 00       	mov    $0x20,%eax
  801ab3:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801ab7:	7e 24                	jle    801add <main+0xad>
        panic("fork claimed to work %d times!\n", n);
  801ab9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801abd:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801ac1:	c7 44 24 08 20 20 80 	movl   $0x802020,0x8(%esp)
  801ac8:	00 
  801ac9:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801ad0:	00 
  801ad1:	c7 04 24 10 20 80 00 	movl   $0x802010,(%esp)
  801ad8:	e8 69 e8 ff ff       	call   800346 <__panic>
    }

    for (; n > 0; n --) {
  801add:	eb 2a                	jmp    801b09 <main+0xd9>
        if (wait() != 0) {
  801adf:	e8 c1 ef ff ff       	call   800aa5 <wait>
  801ae4:	85 c0                	test   %eax,%eax
  801ae6:	74 1c                	je     801b04 <main+0xd4>
            panic("wait stopped early\n");
  801ae8:	c7 44 24 08 40 20 80 	movl   $0x802040,0x8(%esp)
  801aef:	00 
  801af0:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801af7:	00 
  801af8:	c7 04 24 10 20 80 00 	movl   $0x802010,(%esp)
  801aff:	e8 42 e8 ff ff       	call   800346 <__panic>
    ...
    for (; n > 0; n --) {
  801b04:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  801b09:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801b0e:	7f cf                	jg     801adf <main+0xaf>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  801b10:	e8 90 ef ff ff       	call   800aa5 <wait>
  801b15:	85 c0                	test   %eax,%eax
  801b17:	75 1c                	jne    801b35 <main+0x105>
        panic("wait got too many\n");
  801b19:	c7 44 24 08 54 20 80 	movl   $0x802054,0x8(%esp)
  801b20:	00 
  801b21:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801b28:	00 
  801b29:	c7 04 24 10 20 80 00 	movl   $0x802010,(%esp)
  801b30:	e8 11 e8 ff ff       	call   800346 <__panic>
    }

    cprintf("forktest pass.\n");
  801b35:	c7 04 24 67 20 80 00 	movl   $0x802067,(%esp)
  801b3c:	e8 f6 e8 ff ff       	call   800437 <cprintf>
    return 0;
