...
main(void) {
  ...
  801a36:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  801a39:	8b 0d 48 21 80 00    	mov    0x802148,%ecx
  801a3f:	b8 01 00 00 00       	mov    $0x1,%eax
  801a44:	99                   	cltd   
  801a45:	f7 f9                	idiv   %ecx
  801a47:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a4b:	c7 04 24 00 1f 80 00 	movl   $0x801f00,(%esp)
  801a52:	e8 e0 e9 ff ff       	call   800437 <cprintf>
    panic("FAIL: T.T\n");
  801a57:	c7 44 24 08 0e 1f 80 	movl   $0x801f0e,0x8(%esp)
  801a5e:	00 
  801a5f:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801a66:	00 
  801a67:	c7 04 24 19 1f 80 00 	movl   $0x801f19,(%esp)
  801a6e:	e8 d3 e8 ff ff       	call   800346 <__panic>
