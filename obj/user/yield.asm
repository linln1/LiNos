...
main(void) {
  ...
  801a39:	e8 bd f0 ff ff       	call   800afb <getpid>
  801a3e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a42:	c7 04 24 40 1f 80 00 	movl   $0x801f40,(%esp)
  801a49:	e8 e9 e9 ff ff       	call   800437 <cprintf>
    for (i = 0; i < 5; i ++) {
  801a4e:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a55:	00 
  801a56:	eb 27                	jmp    801a7f <main+0x4f>
        yield();
  801a58:	e8 7e f0 ff ff       	call   800adb <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801a5d:	e8 99 f0 ff ff       	call   800afb <getpid>
  801a62:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801a66:	89 54 24 08          	mov    %edx,0x8(%esp)
  801a6a:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a6e:	c7 04 24 5c 1f 80 00 	movl   $0x801f5c,(%esp)
  801a75:	e8 bd e9 ff ff       	call   800437 <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  801a7a:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a7f:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a84:	7e d2                	jle    801a58 <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  801a86:	e8 70 f0 ff ff       	call   800afb <getpid>
  801a8b:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a8f:	c7 04 24 7f 1f 80 00 	movl   $0x801f7f,(%esp)
  801a96:	e8 9c e9 ff ff       	call   800437 <cprintf>
    cprintf("yield pass.\n");
  801a9b:	c7 04 24 98 1f 80 00 	movl   $0x801f98,(%esp)
  801aa2:	e8 90 e9 ff ff       	call   800437 <cprintf>
    return 0;
