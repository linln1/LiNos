...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 80 1b 80 00 	movl   $0x801b80,(%esp)
  ...
  8002de:	c7 04 24 8b 1b 80 00 	movl   $0x801b8b,(%esp)
  ...
  8002f4:	c7 04 24 9d 1b 80 00 	movl   $0x801b9d,(%esp)
  ...
  80030a:	c7 04 24 b0 1b 80 00 	movl   $0x801bb0,(%esp)
  ...
  800320:	c7 04 24 c3 1b 80 00 	movl   $0x801bc3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 d6 1b 80 00 	movl   $0x801bd6,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 f0 1b 80 00 	movl   $0x801bf0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 f2 1b 80 00 	movl   $0x801bf2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 f0 1b 80 00 	movl   $0x801bf0,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 0e 1c 80 00 	movl   $0x801c0e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 21 1c 80 	movl   $0x801c21,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 28 1c 80 	movl   $0x801c28,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 42 1c 80 00 	movl   $0x801c42,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 54 1c 80 	movl   $0x801c54,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 5c 1c 80 	movl   $0x801c5c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 42 1c 80 00 	movl   $0x801c42,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 84 1e 80 00       	add    $0x801e84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 a8 1e 80 00 	mov    0x801ea8(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 9e 1e 80 	movl   $0x801e9e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be a1 1e 80 00       	mov    $0x801ea1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801a36:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  801a39:	e8 5a f0 ff ff       	call   800a98 <fork>
  801a3e:	89 44 24 18          	mov    %eax,0x18(%esp)
  801a42:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801a47:	75 33                	jne    801a7c <main+0x4c>
        cprintf("fork ok.\n");
  801a49:	c7 04 24 00 20 80 00 	movl   $0x802000,(%esp)
  801a50:	e8 e2 e9 ff ff       	call   800437 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  801a55:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a5c:	00 
  801a5d:	eb 0a                	jmp    801a69 <main+0x39>
            yield();
  801a5f:	e8 77 f0 ff ff       	call   800adb <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  801a64:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a69:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  801a6e:	7e ef                	jle    801a5f <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  801a70:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  801a77:	e8 fd ef ff ff       	call   800a79 <exit>
    }
    assert(pid > 0);
  801a7c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801a81:	7f 24                	jg     801aa7 <main+0x77>
  801a83:	c7 44 24 0c 0a 20 80 	movl   $0x80200a,0xc(%esp)
  801a8a:	00 
  801a8b:	c7 44 24 08 12 20 80 	movl   $0x802012,0x8(%esp)
  801a92:	00 
  801a93:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801a9a:	00 
  801a9b:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  801aa2:	e8 9f e8 ff ff       	call   800346 <__panic>
    assert(waitpid(-1, NULL) != 0);
  801aa7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801aae:	00 
  801aaf:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801ab6:	e8 06 f0 ff ff       	call   800ac1 <waitpid>
  801abb:	85 c0                	test   %eax,%eax
  801abd:	75 24                	jne    801ae3 <main+0xb3>
  801abf:	c7 44 24 0c 35 20 80 	movl   $0x802035,0xc(%esp)
  801ac6:	00 
  801ac7:	c7 44 24 08 12 20 80 	movl   $0x802012,0x8(%esp)
  801ace:	00 
  801acf:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801ad6:	00 
  801ad7:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  801ade:	e8 63 e8 ff ff       	call   800346 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801ae3:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801aea:	c0 
  801aeb:	8b 44 24 18          	mov    0x18(%esp),%eax
  801aef:	89 04 24             	mov    %eax,(%esp)
  801af2:	e8 ca ef ff ff       	call   800ac1 <waitpid>
  801af7:	85 c0                	test   %eax,%eax
  801af9:	75 24                	jne    801b1f <main+0xef>
  801afb:	c7 44 24 0c 4c 20 80 	movl   $0x80204c,0xc(%esp)
  801b02:	00 
  801b03:	c7 44 24 08 12 20 80 	movl   $0x802012,0x8(%esp)
  801b0a:	00 
  801b0b:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  801b12:	00 
  801b13:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  801b1a:	e8 27 e8 ff ff       	call   800346 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  801b1f:	8d 44 24 14          	lea    0x14(%esp),%eax
  801b23:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b27:	8b 44 24 18          	mov    0x18(%esp),%eax
  801b2b:	89 04 24             	mov    %eax,(%esp)
  801b2e:	e8 8e ef ff ff       	call   800ac1 <waitpid>
  801b33:	85 c0                	test   %eax,%eax
  801b35:	75 0b                	jne    801b42 <main+0x112>
  801b37:	8b 44 24 14          	mov    0x14(%esp),%eax
  801b3b:	3d af be 00 00       	cmp    $0xbeaf,%eax
  801b40:	74 24                	je     801b66 <main+0x136>
  801b42:	c7 44 24 0c 74 20 80 	movl   $0x802074,0xc(%esp)
  801b49:	00 
  801b4a:	c7 44 24 08 12 20 80 	movl   $0x802012,0x8(%esp)
  801b51:	00 
  801b52:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801b59:	00 
  801b5a:	c7 04 24 27 20 80 00 	movl   $0x802027,(%esp)
  801b61:	e8 e0 e7 ff ff       	call   800346 <__panic>
    cprintf("badarg pass.\n");
  801b66:	c7 04 24 a9 20 80 00 	movl   $0x8020a9,(%esp)
  801b6d:	e8 c5 e8 ff ff       	call   800437 <cprintf>
    return 0;
