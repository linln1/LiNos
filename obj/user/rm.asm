...
obj/__user_rm.out：     文件格式 elf32-i386
...
umain(int argc, char *argv[]) {
  ...
  800d3a:	e8 56 0d 00 00       	call   801a95 <main>
...
static int safe_delete(const char *path, int type) {
  ...
  801a43:	e8 f0 e6 ff ff       	call   800138 <delete>
  801a48:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == 0);
  801a4b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801a4f:	74 24                	je     801a75 <safe_delete+0x45>
  801a51:	c7 44 24 0c 60 1f 80 	movl   $0x801f60,0xc(%esp)
  801a58:	00 
  801a59:	c7 44 24 08 69 1f 80 	movl   $0x801f69,0x8(%esp)
  801a60:	00 
  801a61:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801a68:	00 
  801a69:	c7 04 24 7e 1f 80 00 	movl   $0x801f7e,(%esp)
  801a70:	e8 d1 e8 ff ff       	call   800346 <__panic>
	printf("file named '%s' deleted\n", path);
  801a75:	8b 45 08             	mov    0x8(%ebp),%eax
  801a78:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a7c:	c7 44 24 04 88 1f 80 	movl   $0x801f88,0x4(%esp)
  801a83:	00 
  801a84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a8b:	e8 8b ea ff ff       	call   80051b <fprintf>
	return ret;
...
int main(int argc, char** argv)
{
  ...
  801a98:	83 e4 f0             	and    $0xfffffff0,%esp
  801a9b:	83 ec 10             	sub    $0x10,%esp
	if(argc != 2){
  801a9e:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801aa2:	74 14                	je     801ab8 <main+0x23>
		printf("[error] : wrong number of params\n");	
  801aa4:	c7 44 24 04 a4 1f 80 	movl   $0x801fa4,0x4(%esp)
  801aab:	00 
  801aac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ab3:	e8 63 ea ff ff       	call   80051b <fprintf>
	}
	safe_delete(argv[1], 1);
  801ab8:	8b 45 0c             	mov    0xc(%ebp),%eax
  801abb:	83 c0 04             	add    $0x4,%eax
  801abe:	8b 00                	mov    (%eax),%eax
  801ac0:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  801ac7:	00 
  801ac8:	89 04 24             	mov    %eax,(%esp)
  801acb:	e8 60 ff ff ff       	call   801a30 <safe_delete>
	return 0;
