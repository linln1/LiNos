...
obj/__user_rename.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 a0 1a 80 00 	movl   $0x801aa0,(%esp)
  ...
  8002de:	c7 04 24 ab 1a 80 00 	movl   $0x801aab,(%esp)
  ...
  8002f4:	c7 04 24 bd 1a 80 00 	movl   $0x801abd,(%esp)
  ...
  80030a:	c7 04 24 d0 1a 80 00 	movl   $0x801ad0,(%esp)
  ...
  800320:	c7 04 24 e3 1a 80 00 	movl   $0x801ae3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 f6 1a 80 00 	movl   $0x801af6,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 10 1b 80 00 	movl   $0x801b10,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 12 1b 80 00 	movl   $0x801b12,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 10 1b 80 00 	movl   $0x801b10,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 2e 1b 80 00 	movl   $0x801b2e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 41 1b 80 	movl   $0x801b41,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 48 1b 80 	movl   $0x801b48,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 62 1b 80 00 	movl   $0x801b62,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 74 1b 80 	movl   $0x801b74,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 7c 1b 80 	movl   $0x801b7c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 62 1b 80 00 	movl   $0x801b62,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 a4 1d 80 00       	add    $0x801da4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 c8 1d 80 00 	mov    0x801dc8(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c be 1d 80 	movl   $0x801dbe,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be c1 1d 80 00       	mov    $0x801dc1,%esi
            }
            if (width > 0 && padc != '-') {
...
int main(int argc, char** argv)
{
  ...
  801a36:	83 ec 20             	sub    $0x20,%esp
	if(argc != 3){
  801a39:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
  801a3d:	74 1b                	je     801a5a <main+0x2a>
		printf("[error] : wrong number of params! \n");	
  801a3f:	c7 44 24 04 20 1f 80 	movl   $0x801f20,0x4(%esp)
  801a46:	00 
  801a47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a4e:	e8 c8 ea ff ff       	call   80051b <fprintf>
		return -1;
  801a53:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a58:	eb 40                	jmp    801a9a <main+0x6a>
	}

	int ret = rename(argv[1], argv[2]);
  801a5a:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a5d:	83 c0 08             	add    $0x8,%eax
  801a60:	8b 10                	mov    (%eax),%edx
  801a62:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a65:	83 c0 04             	add    $0x4,%eax
  801a68:	8b 00                	mov    (%eax),%eax
  801a6a:	89 54 24 04          	mov    %edx,0x4(%esp)
  801a6e:	89 04 24             	mov    %eax,(%esp)
  801a71:	e8 99 e7 ff ff       	call   80020f <rename>
  801a76:	89 44 24 1c          	mov    %eax,0x1c(%esp)

	if(ret == 0)
  801a7a:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a7f:	75 14                	jne    801a95 <main+0x65>
		printf("rename successful!\n");
  801a81:	c7 44 24 04 44 1f 80 	movl   $0x801f44,0x4(%esp)
  801a88:	00 
  801a89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a90:	e8 86 ea ff ff       	call   80051b <fprintf>
