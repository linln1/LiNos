...
obj/__user_priorqueue.out：     文件格式 elf32-i386
...
main(void)
{
  ...
  801a39:	c7 04 24 00 87 93 03 	movl   $0x3938700,(%esp)
  801a40:	e8 d0 f0 ff ff       	call   800b15 <lab6_set_priority>
    for(i=0;i<5;i++)
  801a45:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a4c:	00 
  801a4d:	eb 4a                	jmp    801a99 <main+0x69>
    {
    	
    	if((pid=fork())==0)
  801a4f:	e8 44 f0 ff ff       	call   800a98 <fork>
  801a54:	89 44 24 14          	mov    %eax,0x14(%esp)
  801a58:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  801a5d:	75 35                	jne    801a94 <main+0x64>
    	{
    	    lab6_set_priority( (i+1)*10000000 );
  801a5f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a63:	83 c0 01             	add    $0x1,%eax
  801a66:	69 c0 80 96 98 00    	imul   $0x989680,%eax,%eax
  801a6c:	89 04 24             	mov    %eax,(%esp)
  801a6f:	e8 a1 f0 ff ff       	call   800b15 <lab6_set_priority>
	    int i=0;
  801a74:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  801a7b:	00 
	    yield();
  801a7c:	e8 5a f0 ff ff       	call   800adb <yield>
    	    while(i<MAX_TICKS){
  801a81:	eb 05                	jmp    801a88 <main+0x58>
		i++;
  801a83:	83 44 24 18 01       	addl   $0x1,0x18(%esp)
    	if((pid=fork())==0)
    	{
    	    lab6_set_priority( (i+1)*10000000 );
	    int i=0;
	    yield();
    	    while(i<MAX_TICKS){
  801a88:	81 7c 24 18 ff e0 f5 	cmpl   $0x5f5e0ff,0x18(%esp)
  801a8f:	05 
  801a90:	7e f1                	jle    801a83 <main+0x53>
		i++;
	    }
	    break;
  801a92:	eb 0c                	jmp    801aa0 <main+0x70>
int 
main(void)
{
    int i,j,pid;
    lab6_set_priority(60000000);
    for(i=0;i<5;i++)
  801a94:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a99:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a9e:	7e af                	jle    801a4f <main+0x1f>
	    }
	    break;
	}
