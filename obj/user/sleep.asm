...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 40 1b 80 00 	movl   $0x801b40,(%esp)
  ...
  8002de:	c7 04 24 4b 1b 80 00 	movl   $0x801b4b,(%esp)
  ...
  8002f4:	c7 04 24 5d 1b 80 00 	movl   $0x801b5d,(%esp)
  ...
  80030a:	c7 04 24 70 1b 80 00 	movl   $0x801b70,(%esp)
  ...
  800320:	c7 04 24 83 1b 80 00 	movl   $0x801b83,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 96 1b 80 00 	movl   $0x801b96,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 b0 1b 80 00 	movl   $0x801bb0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 b2 1b 80 00 	movl   $0x801bb2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 b0 1b 80 00 	movl   $0x801bb0,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ce 1b 80 00 	movl   $0x801bce,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 e1 1b 80 	movl   $0x801be1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 e8 1b 80 	movl   $0x801be8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 02 1c 80 00 	movl   $0x801c02,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 14 1c 80 	movl   $0x801c14,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 1c 1c 80 	movl   $0x801c1c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 02 1c 80 00 	movl   $0x801c02,(%esp)
  ...
  800d3a:	e8 45 0d 00 00       	call   801a84 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 44 1e 80 00       	add    $0x801e44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 68 1e 80 00 	mov    0x801e68(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 5e 1e 80 	movl   $0x801e5e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 61 1e 80 00       	mov    $0x801e61,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  801a33:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  801a36:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  801a3d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801a44:	eb 2c                	jmp    801a72 <sleepy+0x42>
        sleep(time);
  801a46:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a49:	89 04 24             	mov    %eax,(%esp)
  801a4c:	e8 d7 f0 ff ff       	call   800b28 <sleep>
  ...
  801a62:	c7 04 24 c0 1f 80 00 	movl   $0x801fc0,(%esp)
  801a69:	e8 c9 e9 ff ff       	call   800437 <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  801a6e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801a72:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801a76:	7e ce                	jle    801a46 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  801a78:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801a7f:	e8 f5 ef ff ff       	call   800a79 <exit>
...
main(void) {
  ...
  801a87:	83 e4 f0             	and    $0xfffffff0,%esp
  801a8a:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  801a8d:	e8 a9 f0 ff ff       	call   800b3b <gettime_msec>
  801a92:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801a96:	e8 fd ef ff ff       	call   800a98 <fork>
  801a9b:	89 44 24 18          	mov    %eax,0x18(%esp)
  801a9f:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801aa4:	75 0c                	jne    801ab2 <main+0x2e>
        sleepy(pid1);
  801aa6:	8b 44 24 18          	mov    0x18(%esp),%eax
  801aaa:	89 04 24             	mov    %eax,(%esp)
  801aad:	e8 7e ff ff ff       	call   801a30 <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  801ab2:	8d 44 24 14          	lea    0x14(%esp),%eax
  801ab6:	89 44 24 04          	mov    %eax,0x4(%esp)
  801aba:	8b 44 24 18          	mov    0x18(%esp),%eax
  801abe:	89 04 24             	mov    %eax,(%esp)
  801ac1:	e8 fb ef ff ff       	call   800ac1 <waitpid>
  801ac6:	85 c0                	test   %eax,%eax
  801ac8:	75 08                	jne    801ad2 <main+0x4e>
  801aca:	8b 44 24 14          	mov    0x14(%esp),%eax
  801ace:	85 c0                	test   %eax,%eax
  801ad0:	74 24                	je     801af6 <main+0x72>
  801ad2:	c7 44 24 0c d8 1f 80 	movl   $0x801fd8,0xc(%esp)
  801ad9:	00 
  801ada:	c7 44 24 08 09 20 80 	movl   $0x802009,0x8(%esp)
  801ae1:	00 
  801ae2:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801ae9:	00 
  801aea:	c7 04 24 1e 20 80 00 	movl   $0x80201e,(%esp)
  801af1:	e8 50 e8 ff ff       	call   800346 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  801af6:	e8 40 f0 ff ff       	call   800b3b <gettime_msec>
  801afb:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  801aff:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b03:	c7 04 24 2b 20 80 00 	movl   $0x80202b,(%esp)
  801b0a:	e8 28 e9 ff ff       	call   800437 <cprintf>
    cprintf("sleep pass.\n");
  801b0f:	c7 04 24 3c 20 80 00 	movl   $0x80203c,(%esp)
  801b16:	e8 1c e9 ff ff       	call   800437 <cprintf>
    return 0;
