...
obj/__user_check_sched.out：     文件格式 elf32-i386
...
int main(void){
  ...
  801a40:	00 
  801a41:	eb 78                	jmp    801abb <main+0x8b>
    {
        int pid;
        if((pid=fork())==0)
  801a43:	e8 50 f0 ff ff       	call   800a98 <fork>
  801a48:	89 44 24 14          	mov    %eax,0x14(%esp)
  801a4c:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  801a51:	75 63                	jne    801ab6 <main+0x86>
        {
            int p=i;
  801a53:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a57:	89 44 24 10          	mov    %eax,0x10(%esp)
            yield();
  801a5b:	e8 7b f0 ff ff       	call   800adb <yield>
            int j;
            for(j=0;j<=6000000;j++){
  801a60:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  801a67:	00 
  801a68:	eb 40                	jmp    801aaa <main+0x7a>
                if(j%2000000==0)
  801a6a:	8b 4c 24 18          	mov    0x18(%esp),%ecx
  801a6e:	ba 83 de 1b 43       	mov    $0x431bde83,%edx
  801a73:	89 c8                	mov    %ecx,%eax
  801a75:	f7 ea                	imul   %edx
  801a77:	c1 fa 13             	sar    $0x13,%edx
  801a7a:	89 c8                	mov    %ecx,%eax
  801a7c:	c1 f8 1f             	sar    $0x1f,%eax
  801a7f:	29 c2                	sub    %eax,%edx
  801a81:	89 d0                	mov    %edx,%eax
  801a83:	69 c0 80 84 1e 00    	imul   $0x1e8480,%eax,%eax
  801a89:	29 c1                	sub    %eax,%ecx
  801a8b:	89 c8                	mov    %ecx,%eax
  801a8d:	85 c0                	test   %eax,%eax
  801a8f:	75 14                	jne    801aa5 <main+0x75>
                    cprintf("%d \n",p);
  801a91:	8b 44 24 10          	mov    0x10(%esp),%eax
  801a95:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a99:	c7 04 24 60 1f 80 00 	movl   $0x801f60,(%esp)
  801aa0:	e8 92 e9 ff ff       	call   800437 <cprintf>
        if((pid=fork())==0)
        {
            ...
            int j;
            for(j=0;j<=6000000;j++){
  801aa5:	83 44 24 18 01       	addl   $0x1,0x18(%esp)
  801aaa:	81 7c 24 18 80 8d 5b 	cmpl   $0x5b8d80,0x18(%esp)
  801ab1:	00 
  801ab2:	7e b6                	jle    801a6a <main+0x3a>
                if(j%2000000==0)
                    cprintf("%d \n",p);
            }
            break;
  801ab4:	eb 0c                	jmp    801ac2 <main+0x92>
#define printf(...)                     fprintf(1, __VA_ARGS__)
...
int main(void){
    int i;
    for(i=0;i<5;i++)
  801ab6:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801abb:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801ac0:	7e 81                	jle    801a43 <main+0x13>
                    cprintf("%d \n",p);
            }
            break;
        }
