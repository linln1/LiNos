...
obj/__user_touch.out：     文件格式 elf32-i386
...
umain(int argc, char *argv[]) {
  ...
  800d3a:	e8 f4 0d 00 00       	call   801b33 <main>
...
static int safe_open(const char *path, int open_flags)
{
  ...
  801a43:	e8 d6 e6 ff ff       	call   80011e <open>
  801a48:	89 45 f4             	mov    %eax,-0xc(%ebp)
	printf("fd is %d\n",fd);
  801a4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a4e:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a52:	c7 44 24 04 80 21 80 	movl   $0x802180,0x4(%esp)
  801a59:	00 
  801a5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a61:	e8 b5 ea ff ff       	call   80051b <fprintf>
	assert(fd >= 0);
  801a66:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801a6a:	79 24                	jns    801a90 <safe_open+0x60>
  801a6c:	c7 44 24 0c 8a 21 80 	movl   $0x80218a,0xc(%esp)
  801a73:	00 
  801a74:	c7 44 24 08 92 21 80 	movl   $0x802192,0x8(%esp)
  801a7b:	00 
  801a7c:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801a83:	00 
  801a84:	c7 04 24 a7 21 80 00 	movl   $0x8021a7,(%esp)
  801a8b:	e8 b6 e8 ff ff       	call   800346 <__panic>
	return fd;
...
static struct stat *safe_fstat(int fd)
{
  ...
  801a9b:	a1 10 30 80 00       	mov    0x803010,%eax
  801aa0:	89 44 24 04          	mov    %eax,0x4(%esp)
  801aa4:	8b 45 08             	mov    0x8(%ebp),%eax
  801aa7:	89 04 24             	mov    %eax,(%esp)
  801aaa:	e8 19 e7 ff ff       	call   8001c8 <fstat>
  801aaf:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == 0);
  801ab2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801ab6:	74 24                	je     801adc <safe_fstat+0x47>
  801ab8:	c7 44 24 0c b4 21 80 	movl   $0x8021b4,0xc(%esp)
  801abf:	00 
  801ac0:	c7 44 24 08 92 21 80 	movl   $0x802192,0x8(%esp)
  801ac7:	00 
  801ac8:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801acf:	00 
  801ad0:	c7 04 24 a7 21 80 00 	movl   $0x8021a7,(%esp)
  801ad7:	e8 6a e8 ff ff       	call   800346 <__panic>
	return stat;
  801adc:	a1 10 30 80 00       	mov    0x803010,%eax
}
  801ae1:	c9                   	leave  
  801ae2:	c3                   	ret    
...
static void safe_read(int fd, void *data, size_t len)
{
  ...
  801afd:	e8 63 e6 ff ff       	call   800165 <read>
  801b02:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == len);
  801b05:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b08:	3b 45 10             	cmp    0x10(%ebp),%eax
  801b0b:	74 24                	je     801b31 <safe_read+0x4e>
  801b0d:	c7 44 24 0c bd 21 80 	movl   $0x8021bd,0xc(%esp)
  801b14:	00 
  801b15:	c7 44 24 08 92 21 80 	movl   $0x802192,0x8(%esp)
  801b1c:	00 
  801b1d:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  801b24:	00 
  801b25:	c7 04 24 a7 21 80 00 	movl   $0x8021a7,(%esp)
  801b2c:	e8 15 e8 ff ff       	call   800346 <__panic>
}
  801b31:	c9                   	leave  
  801b32:	c3                   	ret    
...
int main(int argc, char** argv)
{
  ...
  801b36:	83 e4 f0             	and    $0xfffffff0,%esp
  801b39:	81 ec 30 01 00 00    	sub    $0x130,%esp
	if(argc != 2){
  801b3f:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801b43:	74 14                	je     801b59 <main+0x26>
		printf("[error]: wrong number of params\n");
  801b45:	c7 44 24 04 c8 21 80 	movl   $0x8021c8,0x4(%esp)
  801b4c:	00 
  801b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b54:	e8 c2 e9 ff ff       	call   80051b <fprintf>
	}

	char *file_name = argv[1];
  801b59:	8b 45 0c             	mov    0xc(%ebp),%eax
  801b5c:	8b 40 04             	mov    0x4(%eax),%eax
  801b5f:	89 84 24 28 01 00 00 	mov    %eax,0x128(%esp)
        char path[256];
        int i;
        for(i = 0 ; i < 256 && file_name[i] != '\0'; i++){
  801b66:	c7 84 24 2c 01 00 00 	movl   $0x0,0x12c(%esp)
  801b6d:	00 00 00 00 
  801b71:	eb 2a                	jmp    801b9d <main+0x6a>
        	path[i] = file_name[i];
  801b73:	8b 94 24 2c 01 00 00 	mov    0x12c(%esp),%edx
  801b7a:	8b 84 24 28 01 00 00 	mov    0x128(%esp),%eax
  801b81:	01 d0                	add    %edx,%eax
  801b83:	0f b6 00             	movzbl (%eax),%eax
  801b86:	8d 4c 24 14          	lea    0x14(%esp),%ecx
  801b8a:	8b 94 24 2c 01 00 00 	mov    0x12c(%esp),%edx
  801b91:	01 ca                	add    %ecx,%edx
  801b93:	88 02                	mov    %al,(%edx)
	...
	char *file_name = argv[1];
        ...
        int i;
        for(i = 0 ; i < 256 && file_name[i] != '\0'; i++){
  801b95:	83 84 24 2c 01 00 00 	addl   $0x1,0x12c(%esp)
  801b9c:	01 
  801b9d:	81 bc 24 2c 01 00 00 	cmpl   $0xff,0x12c(%esp)
  801ba4:	ff 00 00 00 
  801ba8:	7f 17                	jg     801bc1 <main+0x8e>
  801baa:	8b 94 24 2c 01 00 00 	mov    0x12c(%esp),%edx
  801bb1:	8b 84 24 28 01 00 00 	mov    0x128(%esp),%eax
  801bb8:	01 d0                	add    %edx,%eax
  801bba:	0f b6 00             	movzbl (%eax),%eax
  801bbd:	84 c0                	test   %al,%al
  801bbf:	75 b2                	jne    801b73 <main+0x40>
        	path[i] = file_name[i];
        }
	path[i] = '\0';
  801bc1:	8d 54 24 14          	lea    0x14(%esp),%edx
  801bc5:	8b 84 24 2c 01 00 00 	mov    0x12c(%esp),%eax
  801bcc:	01 d0                	add    %edx,%eax
  801bce:	c6 00 00             	movb   $0x0,(%eax)
	
	int fd1 = safe_open(path, O_CREAT);
  801bd1:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
  801bd8:	00 
  801bd9:	8d 44 24 14          	lea    0x14(%esp),%eax
  801bdd:	89 04 24             	mov    %eax,(%esp)
  801be0:	e8 4b fe ff ff       	call   801a30 <safe_open>
  801be5:	89 84 24 24 01 00 00 	mov    %eax,0x124(%esp)
	struct stat *stat = safe_fstat(fd1);
  801bec:	8b 84 24 24 01 00 00 	mov    0x124(%esp),%eax
  801bf3:	89 04 24             	mov    %eax,(%esp)
  801bf6:	e8 9a fe ff ff       	call   801a95 <safe_fstat>
  801bfb:	89 84 24 20 01 00 00 	mov    %eax,0x120(%esp)
	assert(stat->st_size >= 0 && stat->st_blocks >= 0);
	printf("%s created successful!\n", path);
  801c02:	8d 44 24 14          	lea    0x14(%esp),%eax
  801c06:	89 44 24 08          	mov    %eax,0x8(%esp)
  801c0a:	c7 44 24 04 e9 21 80 	movl   $0x8021e9,0x4(%esp)
  801c11:	00 
  801c12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c19:	e8 fd e8 ff ff       	call   80051b <fprintf>
	printf("fd1 = %d\n", fd1);
  801c1e:	8b 84 24 24 01 00 00 	mov    0x124(%esp),%eax
  801c25:	89 44 24 08          	mov    %eax,0x8(%esp)
  801c29:	c7 44 24 04 01 22 80 	movl   $0x802201,0x4(%esp)
  801c30:	00 
  801c31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c38:	e8 de e8 ff ff       	call   80051b <fprintf>

	int ret = close(fd1);
  801c3d:	8b 84 24 24 01 00 00 	mov    0x124(%esp),%eax
  801c44:	89 04 24             	mov    %eax,(%esp)
  801c47:	e8 06 e5 ff ff       	call   800152 <close>
  801c4c:	89 84 24 1c 01 00 00 	mov    %eax,0x11c(%esp)
	printf("close'ret = %d\n", ret);
  801c53:	8b 84 24 1c 01 00 00 	mov    0x11c(%esp),%eax
  801c5a:	89 44 24 08          	mov    %eax,0x8(%esp)
  801c5e:	c7 44 24 04 0b 22 80 	movl   $0x80220b,0x4(%esp)
  801c65:	00 
  801c66:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c6d:	e8 a9 e8 ff ff       	call   80051b <fprintf>

	int fd2 = safe_open(path, O_RDONLY);
  801c72:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801c79:	00 
  801c7a:	8d 44 24 14          	lea    0x14(%esp),%eax
  801c7e:	89 04 24             	mov    %eax,(%esp)
  801c81:	e8 aa fd ff ff       	call   801a30 <safe_open>
  801c86:	89 84 24 18 01 00 00 	mov    %eax,0x118(%esp)
	struct stat *stat2 = safe_fstat(fd2);
  801c8d:	8b 84 24 18 01 00 00 	mov    0x118(%esp),%eax
  801c94:	89 04 24             	mov    %eax,(%esp)
  801c97:	e8 f9 fd ff ff       	call   801a95 <safe_fstat>
  801c9c:	89 84 24 14 01 00 00 	mov    %eax,0x114(%esp)
	assert(stat2->st_size >= 0 && stat2->st_blocks >= 0);
	printf("%s created successful!\n", path);
  801ca3:	8d 44 24 14          	lea    0x14(%esp),%eax
  801ca7:	89 44 24 08          	mov    %eax,0x8(%esp)
  801cab:	c7 44 24 04 e9 21 80 	movl   $0x8021e9,0x4(%esp)
  801cb2:	00 
  801cb3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cba:	e8 5c e8 ff ff       	call   80051b <fprintf>
	printf("fd2 = %d\n", fd2);
  801cbf:	8b 84 24 18 01 00 00 	mov    0x118(%esp),%eax
  801cc6:	89 44 24 08          	mov    %eax,0x8(%esp)
  801cca:	c7 44 24 04 1b 22 80 	movl   $0x80221b,0x4(%esp)
  801cd1:	00 
  801cd2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cd9:	e8 3d e8 ff ff       	call   80051b <fprintf>

	close(fd2);
  801cde:	8b 84 24 18 01 00 00 	mov    0x118(%esp),%eax
  801ce5:	89 04 24             	mov    %eax,(%esp)
  801ce8:	e8 65 e4 ff ff       	call   800152 <close>
