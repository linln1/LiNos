...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 20 1e 80 00 	movl   $0x801e20,(%esp)
  ...
  8002de:	c7 04 24 2b 1e 80 00 	movl   $0x801e2b,(%esp)
  ...
  8002f4:	c7 04 24 3d 1e 80 00 	movl   $0x801e3d,(%esp)
  ...
  80030a:	c7 04 24 50 1e 80 00 	movl   $0x801e50,(%esp)
  ...
  800320:	c7 04 24 63 1e 80 00 	movl   $0x801e63,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 76 1e 80 00 	movl   $0x801e76,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 90 1e 80 00 	movl   $0x801e90,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 92 1e 80 00 	movl   $0x801e92,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 90 1e 80 00 	movl   $0x801e90,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ae 1e 80 00 	movl   $0x801eae,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 c1 1e 80 	movl   $0x801ec1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 c8 1e 80 	movl   $0x801ec8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 e2 1e 80 00 	movl   $0x801ee2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 f4 1e 80 	movl   $0x801ef4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 fc 1e 80 	movl   $0x801efc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 e2 1e 80 00 	movl   $0x801ee2,(%esp)
  ...
  800d3a:	e8 29 0f 00 00       	call   801c68 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 24 21 80 00       	add    $0x802124,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 48 21 80 00 	mov    0x802148(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 3e 21 80 	movl   $0x80213e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 41 21 80 00       	mov    $0x802141,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  801a33:	53                   	push   %ebx
  801a34:	83 ec 24             	sub    $0x24,%esp
    int i, j, k, size = MATSIZE;
  801a37:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  801a3e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801a45:	eb 65                	jmp    801aac <work+0x7c>
        for (j = 0; j < size; j ++) {
  801a47:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801a4e:	eb 50                	jmp    801aa0 <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  801a61:	c7 04 85 e0 31 80 00 	movl   $0x1,0x8031e0(,%eax,4)
  801a68:	01 00 00 00 
  ...
  801a7d:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  801a90:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801a93:	01 d0                	add    %edx,%eax
  801a95:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  801a9c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801aa0:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801aa3:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801aa6:	7c a8                	jl     801a50 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801aa8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801aac:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801aaf:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801ab2:	7c 93                	jl     801a47 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801ab4:	e8 22 f0 ff ff       	call   800adb <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801ab9:	e8 3d f0 ff ff       	call   800afb <getpid>
  801abe:	8b 55 08             	mov    0x8(%ebp),%edx
  801ac1:	89 54 24 08          	mov    %edx,0x8(%esp)
  801ac5:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ac9:	c7 04 24 a0 22 80 00 	movl   $0x8022a0,(%esp)
  801ad0:	e8 62 e9 ff ff       	call   800437 <cprintf>

    while (times -- > 0) {
  801ad5:	e9 5c 01 00 00       	jmp    801c36 <work+0x206>
        for (i = 0; i < size; i ++) {
  801ada:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801ae1:	e9 b6 00 00 00       	jmp    801b9c <work+0x16c>
            for (j = 0; j < size; j ++) {
  801ae6:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801aed:	e9 9a 00 00 00       	jmp    801b8c <work+0x15c>
                matc[i][j] = 0;
  801af2:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801af5:	89 d0                	mov    %edx,%eax
  801af7:	c1 e0 02             	shl    $0x2,%eax
  801afa:	01 d0                	add    %edx,%eax
  801afc:	01 c0                	add    %eax,%eax
  801afe:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801b01:	01 d0                	add    %edx,%eax
  801b03:	c7 04 85 80 33 80 00 	movl   $0x0,0x803380(,%eax,4)
  801b0a:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  801b0e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801b15:	eb 69                	jmp    801b80 <work+0x150>
  ...
  801b28:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  801b40:	8b 1c 85 40 30 80 00 	mov    0x803040(,%eax,4),%ebx
  801b47:	8b 55 ec             	mov    -0x14(%ebp),%edx
  ...
  801b58:	8b 04 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%eax
  801b5f:	0f af c3             	imul   %ebx,%eax
  801b62:	01 c1                	add    %eax,%ecx
  ...
  801b70:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801b73:	01 d0                	add    %edx,%eax
  801b75:	89 0c 85 80 33 80 00 	mov    %ecx,0x803380(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  801b7c:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  801b80:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801b83:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801b86:	7c 8f                	jl     801b17 <work+0xe7>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801b88:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801b8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b8f:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801b92:	0f 8c 5a ff ff ff    	jl     801af2 <work+0xc2>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801b98:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801b9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b9f:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801ba2:	0f 8c 3e ff ff ff    	jl     801ae6 <work+0xb6>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  801baf:	eb 79                	jmp    801c2a <work+0x1fa>
            for (j = 0; j < size; j ++) {
  801bb1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801bb8:	eb 64                	jmp    801c1e <work+0x1ee>
  ...
  801bf6:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801bf9:	01 d0                	add    %edx,%eax
  801bfb:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  801c0e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801c11:	01 d0                	add    %edx,%eax
  801c13:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801c1a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801c1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801c21:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801c24:	7c 94                	jl     801bba <work+0x18a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  801c26:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801c2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c2d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801c30:	0f 8c 7b ff ff ff    	jl     801bb1 <work+0x181>
  ...
  801c39:	8d 50 ff             	lea    -0x1(%eax),%edx
  801c3c:	89 55 08             	mov    %edx,0x8(%ebp)
  801c3f:	85 c0                	test   %eax,%eax
  801c41:	0f 85 93 fe ff ff    	jne    801ada <work+0xaa>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  801c47:	e8 af ee ff ff       	call   800afb <getpid>
  801c4c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801c50:	c7 04 24 c0 22 80 00 	movl   $0x8022c0,(%esp)
  801c57:	e8 db e7 ff ff       	call   800437 <cprintf>
    exit(0);
  801c5c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801c63:	e8 11 ee ff ff       	call   800a79 <exit>
...
main(void) {
  ...
  801c76:	53                   	push   %ebx
  801c77:	51                   	push   %ecx
  801c78:	83 ec 2c             	sub    $0x2c,%esp
  801c7b:	89 e0                	mov    %esp,%eax
  801c7d:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801c7f:	b8 15 00 00 00       	mov    $0x15,%eax
  801c84:	83 e8 01             	sub    $0x1,%eax
  801c87:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801c8a:	b8 15 00 00 00       	mov    $0x15,%eax
  801c8f:	c1 e0 02             	shl    $0x2,%eax
  801c92:	8d 50 03             	lea    0x3(%eax),%edx
  801c95:	b8 10 00 00 00       	mov    $0x10,%eax
  801c9a:	83 e8 01             	sub    $0x1,%eax
  801c9d:	01 d0                	add    %edx,%eax
  801c9f:	be 10 00 00 00       	mov    $0x10,%esi
  801ca4:	ba 00 00 00 00       	mov    $0x0,%edx
  801ca9:	f7 f6                	div    %esi
  801cab:	6b c0 10             	imul   $0x10,%eax,%eax
  801cae:	29 c4                	sub    %eax,%esp
  801cb0:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801cb4:	83 c0 03             	add    $0x3,%eax
  801cb7:	c1 e8 02             	shr    $0x2,%eax
  801cba:	c1 e0 02             	shl    $0x2,%eax
  801cbd:	89 45 dc             	mov    %eax,-0x24(%ebp)
    memset(pids, 0, sizeof(pids));
  801cc0:	b8 15 00 00 00       	mov    $0x15,%eax
  801cc5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801ccc:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801ccf:	89 54 24 08          	mov    %edx,0x8(%esp)
  801cd3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801cda:	00 
  801cdb:	89 04 24             	mov    %eax,(%esp)
  801cde:	e8 c4 fb ff ff       	call   8018a7 <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801ce3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801cea:	eb 70                	jmp    801d5c <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801cec:	e8 a7 ed ff ff       	call   800a98 <fork>
  801cf1:	8b 55 dc             	mov    -0x24(%ebp),%edx
  801cf4:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  801cf7:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801cfa:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801cfd:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801d00:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801d03:	85 c0                	test   %eax,%eax
  801d05:	75 42                	jne    801d49 <main+0xe1>
            srand(i * i);
  801d07:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801d0a:	0f af 45 e4          	imul   -0x1c(%ebp),%eax
  801d0e:	89 04 24             	mov    %eax,(%esp)
  801d11:	e8 23 f8 ff ff       	call   801539 <srand>
            int times = (((unsigned int)rand()) % total);
  801d16:	e8 5e f7 ff ff       	call   801479 <rand>
  801d1b:	ba 15 00 00 00       	mov    $0x15,%edx
  ...
  801d31:	0f af 45 d8          	imul   -0x28(%ebp),%eax
  801d35:	83 c0 0a             	add    $0xa,%eax
  801d38:	6b c0 64             	imul   $0x64,%eax,%eax
  801d3b:	89 45 d8             	mov    %eax,-0x28(%ebp)
            work(times);
  801d3e:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801d41:	89 04 24             	mov    %eax,(%esp)
  801d44:	e8 e7 fc ff ff       	call   801a30 <work>
        }
        if (pids[i] < 0) {
  801d49:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801d4c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801d4f:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801d52:	85 c0                	test   %eax,%eax
  801d54:	79 02                	jns    801d58 <main+0xf0>
            goto failed;
  801d56:	eb 5d                	jmp    801db5 <main+0x14d>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801d58:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801d5c:	b8 15 00 00 00       	mov    $0x15,%eax
  801d61:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801d64:	7c 86                	jl     801cec <main+0x84>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  801d66:	c7 04 24 d4 22 80 00 	movl   $0x8022d4,(%esp)
  801d6d:	e8 c5 e6 ff ff       	call   800437 <cprintf>

    for (i = 0; i < total; i ++) {
  801d72:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801d79:	eb 1b                	jmp    801d96 <main+0x12e>
        if (wait() != 0) {
  801d7b:	e8 25 ed ff ff       	call   800aa5 <wait>
  801d80:	85 c0                	test   %eax,%eax
  801d82:	74 0e                	je     801d92 <main+0x12a>
            cprintf("wait failed.\n");
  801d84:	c7 04 24 de 22 80 00 	movl   $0x8022de,(%esp)
  801d8b:	e8 a7 e6 ff ff       	call   800437 <cprintf>
            goto failed;
  801d90:	eb 23                	jmp    801db5 <main+0x14d>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  801d92:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801d96:	b8 15 00 00 00       	mov    $0x15,%eax
  801d9b:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801d9e:	7c db                	jl     801d7b <main+0x113>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801da0:	c7 04 24 ec 22 80 00 	movl   $0x8022ec,(%esp)
  801da7:	e8 8b e6 ff ff       	call   800437 <cprintf>
    return 0;
  801dac:	b8 00 00 00 00       	mov    $0x0,%eax
  801db1:	89 dc                	mov    %ebx,%esp
  801db3:	eb 51                	jmp    801e06 <main+0x19e>

failed:
    for (i = 0; i < total; i ++) {
  801db5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801dbc:	eb 22                	jmp    801de0 <main+0x178>
        if (pids[i] > 0) {
  801dbe:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801dc1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801dc4:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801dc7:	85 c0                	test   %eax,%eax
  801dc9:	7e 11                	jle    801ddc <main+0x174>
            kill(pids[i]);
  801dcb:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801dce:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801dd1:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801dd4:	89 04 24             	mov    %eax,(%esp)
  801dd7:	e8 0c ed ff ff       	call   800ae8 <kill>
...
failed:
    for (i = 0; i < total; i ++) {
  801ddc:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801de0:	b8 15 00 00 00       	mov    $0x15,%eax
  801de5:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801de8:	7c d4                	jl     801dbe <main+0x156>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801dea:	c7 44 24 08 fa 22 80 	movl   $0x8022fa,0x8(%esp)
  801df1:	00 
  801df2:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801df9:	00 
  801dfa:	c7 04 24 05 23 80 00 	movl   $0x802305,(%esp)
  801e01:	e8 40 e5 ff ff       	call   800346 <__panic>
}
  ...
  801e0b:	5e                   	pop    %esi
  801e0c:	5d                   	pop    %ebp
  801e0d:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801e10:	c3                   	ret    
