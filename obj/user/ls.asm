...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 40 1e 80 00 	movl   $0x801e40,(%esp)
  ...
  8002de:	c7 04 24 4b 1e 80 00 	movl   $0x801e4b,(%esp)
  ...
  8002f4:	c7 04 24 5d 1e 80 00 	movl   $0x801e5d,(%esp)
  ...
  80030a:	c7 04 24 70 1e 80 00 	movl   $0x801e70,(%esp)
  ...
  800320:	c7 04 24 83 1e 80 00 	movl   $0x801e83,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 96 1e 80 00 	movl   $0x801e96,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 b0 1e 80 00 	movl   $0x801eb0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 b2 1e 80 00 	movl   $0x801eb2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 b0 1e 80 00 	movl   $0x801eb0,(%esp)
...
lock_fork(void) {
  ...
  800a54:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  800a57:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
unlock_fork(void) {
  ...
  800a68:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  800a6b:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ce 1e 80 00 	movl   $0x801ece,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 e1 1e 80 	movl   $0x801ee1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 e8 1e 80 	movl   $0x801ee8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 02 1f 80 00 	movl   $0x801f02,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 14 1f 80 	movl   $0x801f14,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 1c 1f 80 	movl   $0x801f1c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 02 1f 80 00 	movl   $0x801f02,(%esp)
  ...
  800d3a:	e8 36 10 00 00       	call   801d75 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 44 21 80 00       	add    $0x802144,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 68 21 80 00 	mov    0x802168(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 5e 21 80 	movl   $0x80215e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 61 21 80 00       	mov    $0x802161,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  801a33:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  801a36:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  801a3a:	8b 45 08             	mov    0x8(%ebp),%eax
  801a3d:	25 00 70 00 00       	and    $0x7000,%eax
  801a42:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801a47:	75 04                	jne    801a4d <getmode+0x1d>
  801a49:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  801a4d:	8b 45 08             	mov    0x8(%ebp),%eax
  801a50:	25 00 70 00 00       	and    $0x7000,%eax
  801a55:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801a5a:	75 04                	jne    801a60 <getmode+0x30>
  801a5c:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  801a60:	8b 45 08             	mov    0x8(%ebp),%eax
  801a63:	25 00 70 00 00       	and    $0x7000,%eax
  801a68:	3d 00 30 00 00       	cmp    $0x3000,%eax
  801a6d:	75 04                	jne    801a73 <getmode+0x43>
  801a6f:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  801a73:	8b 45 08             	mov    0x8(%ebp),%eax
  801a76:	25 00 70 00 00       	and    $0x7000,%eax
  801a7b:	3d 00 40 00 00       	cmp    $0x4000,%eax
  801a80:	75 04                	jne    801a86 <getmode+0x56>
  801a82:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801a86:	8b 45 08             	mov    0x8(%ebp),%eax
  801a89:	25 00 70 00 00       	and    $0x7000,%eax
  801a8e:	3d 00 50 00 00       	cmp    $0x5000,%eax
  801a93:	75 04                	jne    801a99 <getmode+0x69>
  801a95:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  801a99:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  801a9d:	c9                   	leave  
  801a9e:	c3                   	ret    
...
getstat(const char *name, struct stat *stat) {
  ...
  801aa2:	83 ec 28             	sub    $0x28,%esp
    int fd, ret;
    if ((fd = open(name, O_RDONLY)) < 0) {
  801aa5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801aac:	00 
  801aad:	8b 45 08             	mov    0x8(%ebp),%eax
  801ab0:	89 04 24             	mov    %eax,(%esp)
  801ab3:	e8 66 e6 ff ff       	call   80011e <open>
  801ab8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801abb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801abf:	79 05                	jns    801ac6 <getstat+0x27>
        return fd;
  801ac1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ac4:	eb 23                	jmp    801ae9 <getstat+0x4a>
    }
    ret = fstat(fd, stat);
...
lsstat(struct stat *stat, const char *filename) {
  ...
  801af9:	e8 32 ff ff ff       	call   801a30 <getmode>
  801afe:	0f be c0             	movsbl %al,%eax
  801b01:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b05:	c7 44 24 04 c0 22 80 	movl   $0x8022c0,0x4(%esp)
  801b0c:	00 
  801b0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b14:	e8 02 ea ff ff       	call   80051b <fprintf>
  ...
  801b23:	c7 44 24 04 c8 22 80 	movl   $0x8022c8,0x4(%esp)
  801b2a:	00 
  801b2b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b32:	e8 e4 e9 ff ff       	call   80051b <fprintf>
    printf(" %8d(b)", stat->st_blocks);
  801b37:	8b 45 08             	mov    0x8(%ebp),%eax
  801b3a:	8b 40 08             	mov    0x8(%eax),%eax
  801b3d:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b41:	c7 44 24 04 d0 22 80 	movl   $0x8022d0,0x4(%esp)
  801b48:	00 
  801b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b50:	e8 c6 e9 ff ff       	call   80051b <fprintf>
    printf(" %8d(s)", stat->st_size);
  801b55:	8b 45 08             	mov    0x8(%ebp),%eax
  801b58:	8b 40 0c             	mov    0xc(%eax),%eax
  801b5b:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b5f:	c7 44 24 04 d8 22 80 	movl   $0x8022d8,0x4(%esp)
  801b66:	00 
  801b67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b6e:	e8 a8 e9 ff ff       	call   80051b <fprintf>
    printf("   %s\n", filename);
  801b73:	8b 45 0c             	mov    0xc(%ebp),%eax
  801b76:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b7a:	c7 44 24 04 e0 22 80 	movl   $0x8022e0,0x4(%esp)
  801b81:	00 
  801b82:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b89:	e8 8d e9 ff ff       	call   80051b <fprintf>
}
  801b8e:	c9                   	leave  
  801b8f:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  801b93:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801b96:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801b99:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    //DIR *dirp = opendir(".");
    DIR *dirp = opendir(path);
  801b9c:	8b 45 08             	mov    0x8(%ebp),%eax
  801b9f:	89 04 24             	mov    %eax,(%esp)
  801ba2:	e8 79 e4 ff ff       	call   800020 <opendir>
  801ba7:	89 45 f0             	mov    %eax,-0x10(%ebp)

    if (dirp == NULL) {
  801baa:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801bae:	75 07                	jne    801bb7 <lsdir+0x27>
        return -1;
  801bb0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801bb5:	eb 7e                	jmp    801c35 <lsdir+0xa5>
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
  801bb7:	eb 44                	jmp    801bfd <lsdir+0x6d>
        if ((ret = getstat(direntp->name, stat)) != 0) {
  801bb9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801bbc:	8d 50 04             	lea    0x4(%eax),%edx
  801bbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801bc2:	89 44 24 04          	mov    %eax,0x4(%esp)
  801bc6:	89 14 24             	mov    %edx,(%esp)
  801bc9:	e8 d1 fe ff ff       	call   801a9f <getstat>
  801bce:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801bd1:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801bd5:	74 11                	je     801be8 <lsdir+0x58>
            goto failed;
  801bd7:	90                   	nop
    }
    printf("lsdir: step 4\n");
...
failed:
  ...
  801bde:	e8 e6 e4 ff ff       	call   8000c9 <closedir>
    return ret;
  801be3:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801be6:	eb 4d                	jmp    801c35 <lsdir+0xa5>
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
  ...
  801c03:	e8 91 e4 ff ff       	call   800099 <readdir>
  801c08:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801c0b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801c0f:	75 a8                	jne    801bb9 <lsdir+0x29>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
    ...
    printf("lsdir: step 4\n");
  801c11:	c7 44 24 04 e7 22 80 	movl   $0x8022e7,0x4(%esp)
  801c18:	00 
  801c19:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c20:	e8 f6 e8 ff ff       	call   80051b <fprintf>
    closedir(dirp);
  801c25:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801c28:	89 04 24             	mov    %eax,(%esp)
  801c2b:	e8 99 e4 ff ff       	call   8000c9 <closedir>
    return 0;
...
ls(const char *path) {
  ...
  801c3a:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801c3d:	8d 45 dc             	lea    -0x24(%ebp),%eax
  801c40:	89 45 f0             	mov    %eax,-0x10(%ebp)
    int ret, type;
  ...
  801c50:	e8 4a fe ff ff       	call   801a9f <getstat>
  801c55:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801c58:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801c5c:	74 08                	je     801c66 <ls+0x2f>
        return ret;
  801c5e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c61:	e9 0d 01 00 00       	jmp    801d73 <ls+0x13c>
        " [ symlink ]",
        " [character]",
        " [  block  ]",
        " [  ?????  ]",
  ...
  801c6e:	e8 bd fd ff ff       	call   801a30 <getmode>
  801c73:	0f be c0             	movsbl %al,%eax
  801c76:	83 f8 63             	cmp    $0x63,%eax
  801c79:	74 38                	je     801cb3 <ls+0x7c>
  801c7b:	83 f8 63             	cmp    $0x63,%eax
  801c7e:	7f 0c                	jg     801c8c <ls+0x55>
  801c80:	83 f8 30             	cmp    $0x30,%eax
  801c83:	74 13                	je     801c98 <ls+0x61>
  801c85:	83 f8 62             	cmp    $0x62,%eax
  801c88:	74 32                	je     801cbc <ls+0x85>
  801c8a:	eb 39                	jmp    801cc5 <ls+0x8e>
  801c8c:	83 f8 64             	cmp    $0x64,%eax
  801c8f:	74 10                	je     801ca1 <ls+0x6a>
  801c91:	83 f8 6c             	cmp    $0x6c,%eax
  801c94:	74 14                	je     801caa <ls+0x73>
  801c96:	eb 2d                	jmp    801cc5 <ls+0x8e>
    case '0': type = 0; break;
  801c98:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801c9f:	eb 2c                	jmp    801ccd <ls+0x96>
    case 'd': type = 1; break;
  801ca1:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801ca8:	eb 23                	jmp    801ccd <ls+0x96>
    case 'l': type = 2; break;
  801caa:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801cb1:	eb 1a                	jmp    801ccd <ls+0x96>
    case 'c': type = 3; break;
  801cb3:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801cba:	eb 11                	jmp    801ccd <ls+0x96>
    case 'b': type = 4; break;
  801cbc:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  801cc3:	eb 08                	jmp    801ccd <ls+0x96>
    default:  type = 5; break;
  801cc5:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801ccc:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801ccd:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801cd0:	8b 04 85 10 30 80 00 	mov    0x803010(,%eax,4),%eax
  801cd7:	89 44 24 08          	mov    %eax,0x8(%esp)
  801cdb:	c7 44 24 04 f6 22 80 	movl   $0x8022f6,0x4(%esp)
  801ce2:	00 
  801ce3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cea:	e8 2c e8 ff ff       	call   80051b <fprintf>
    printf(" %d(hlinks)", stat->st_nlinks);
  801cef:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801cf2:	8b 40 04             	mov    0x4(%eax),%eax
  801cf5:	89 44 24 08          	mov    %eax,0x8(%esp)
  801cf9:	c7 44 24 04 ff 22 80 	movl   $0x8022ff,0x4(%esp)
  801d00:	00 
  801d01:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d08:	e8 0e e8 ff ff       	call   80051b <fprintf>
  ...
  801d17:	c7 44 24 04 0b 23 80 	movl   $0x80230b,0x4(%esp)
  801d1e:	00 
  801d1f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d26:	e8 f0 e7 ff ff       	call   80051b <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  ...
  801d3c:	c7 44 24 04 17 23 80 	movl   $0x802317,0x4(%esp)
  801d43:	00 
  801d44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d4b:	e8 cb e7 ff ff       	call   80051b <fprintf>
    if (S_ISDIR(stat->st_mode)) {
  801d50:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801d53:	8b 00                	mov    (%eax),%eax
  801d55:	25 00 70 00 00       	and    $0x7000,%eax
  801d5a:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801d5f:	75 0d                	jne    801d6e <ls+0x137>
        return lsdir(path);
  801d61:	8b 45 08             	mov    0x8(%ebp),%eax
  801d64:	89 04 24             	mov    %eax,(%esp)
  801d67:	e8 24 fe ff ff       	call   801b90 <lsdir>
  801d6c:	eb 05                	jmp    801d73 <ls+0x13c>
    }
    return 0;
...
main(int argc, char **argv) {
  ...
  801d78:	83 e4 f0             	and    $0xfffffff0,%esp
  801d7b:	83 ec 20             	sub    $0x20,%esp

	printf("\n>>>>>\n");
  801d7e:	c7 44 24 04 2b 23 80 	movl   $0x80232b,0x4(%esp)
  801d85:	00 
  801d86:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d8d:	e8 89 e7 ff ff       	call   80051b <fprintf>
	printf("argc = %d\n", argc);
  801d92:	8b 45 08             	mov    0x8(%ebp),%eax
  801d95:	89 44 24 08          	mov    %eax,0x8(%esp)
  801d99:	c7 44 24 04 33 23 80 	movl   $0x802333,0x4(%esp)
  801da0:	00 
  801da1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801da8:	e8 6e e7 ff ff       	call   80051b <fprintf>
	printf("argv[0] = %s\n", argv[0]);
  801dad:	8b 45 0c             	mov    0xc(%ebp),%eax
  801db0:	8b 00                	mov    (%eax),%eax
  801db2:	89 44 24 08          	mov    %eax,0x8(%esp)
  801db6:	c7 44 24 04 3e 23 80 	movl   $0x80233e,0x4(%esp)
  801dbd:	00 
  801dbe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801dc5:	e8 51 e7 ff ff       	call   80051b <fprintf>

    if (argc == 1) {
  801dca:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  801dce:	75 0e                	jne    801dde <main+0x69>
        return ls(".");
  801dd0:	c7 04 24 4c 23 80 00 	movl   $0x80234c,(%esp)
  801dd7:	e8 5b fe ff ff       	call   801c37 <ls>
  801ddc:	eb 48                	jmp    801e26 <main+0xb1>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801dde:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801de5:	00 
  801de6:	eb 30                	jmp    801e18 <main+0xa3>
            if ((ret = ls(argv[i])) != 0) {
  801de8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  ...
  801dfd:	e8 35 fe ff ff       	call   801c37 <ls>
  801e02:	89 44 24 18          	mov    %eax,0x18(%esp)
  801e06:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801e0b:	74 06                	je     801e13 <main+0x9e>
                return ret;
  801e0d:	8b 44 24 18          	mov    0x18(%esp),%eax
  801e11:	eb 13                	jmp    801e26 <main+0xb1>
    if (argc == 1) {
        return ls(".");
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801e13:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801e18:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801e1c:	3b 45 08             	cmp    0x8(%ebp),%eax
  801e1f:	7c c7                	jl     801de8 <main+0x73>
                return ret;
            }
        }
    }
