...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 60 22 80 00 	movl   $0x802260,(%esp)
  ...
  8002de:	c7 04 24 6b 22 80 00 	movl   $0x80226b,(%esp)
  ...
  8002f4:	c7 04 24 7d 22 80 00 	movl   $0x80227d,(%esp)
  ...
  80030a:	c7 04 24 90 22 80 00 	movl   $0x802290,(%esp)
  ...
  800320:	c7 04 24 a3 22 80 00 	movl   $0x8022a3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 b6 22 80 00 	movl   $0x8022b6,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 d0 22 80 00 	movl   $0x8022d0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 d2 22 80 00 	movl   $0x8022d2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 d0 22 80 00 	movl   $0x8022d0,(%esp)
...
lock_fork(void) {
  ...
  800a54:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  800a57:	c7 04 24 20 30 80 00 	movl   $0x803020,(%esp)
...
unlock_fork(void) {
  ...
  800a68:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  800a6b:	c7 04 24 20 30 80 00 	movl   $0x803020,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ee 22 80 00 	movl   $0x8022ee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 01 23 80 	movl   $0x802301,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 08 23 80 	movl   $0x802308,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 22 23 80 00 	movl   $0x802322,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 34 23 80 	movl   $0x802334,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 3c 23 80 	movl   $0x80233c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 22 23 80 00 	movl   $0x802322,(%esp)
  ...
  800d3a:	e8 f1 13 00 00       	call   802130 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 64 25 80 00       	add    $0x802564,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 88 25 80 00 	mov    0x802588(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 7e 25 80 	movl   $0x80257e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 81 25 80 00       	mov    $0x802581,%esi
            }
            if (width > 0 && padc != '-') {
...
rand(void) {
  ...
  801482:	a1 08 30 80 00       	mov    0x803008,%eax
  801487:	8b 15 0c 30 80 00    	mov    0x80300c,%edx
  ...
  8014b4:	89 0d 08 30 80 00    	mov    %ecx,0x803008
  8014ba:	89 1d 0c 30 80 00    	mov    %ebx,0x80300c
    unsigned long long result = (next >> 12);
  8014c0:	a1 08 30 80 00       	mov    0x803008,%eax
  8014c5:	8b 15 0c 30 80 00    	mov    0x80300c,%edx
...
srand(unsigned int seed) {
  ...
  801544:	a3 08 30 80 00       	mov    %eax,0x803008
  801549:	89 15 0c 30 80 00    	mov    %edx,0x80300c
}
  80154f:	5d                   	pop    %ebp
  801550:	c3                   	ret    
...
gettoken(char **p1, char **p2) {
  ...
  801a42:	75 0a                	jne    801a4e <gettoken+0x1e>
        return 0;
  801a44:	b8 00 00 00 00       	mov    $0x0,%eax
  801a49:	e9 f8 00 00 00       	jmp    801b46 <gettoken+0x116>
    }
    while (strchr(WHITESPACE, *s) != NULL) {
  801a4e:	eb 0c                	jmp    801a5c <gettoken+0x2c>
        *s ++ = '\0';
  801a50:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a53:	8d 50 01             	lea    0x1(%eax),%edx
  801a56:	89 55 f4             	mov    %edx,-0xc(%ebp)
...
gettoken(char **p1, char **p2) {
  ...
  801a5f:	0f b6 00             	movzbl (%eax),%eax
  801a62:	0f be c0             	movsbl %al,%eax
  801a65:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a69:	c7 04 24 e0 26 80 00 	movl   $0x8026e0,(%esp)
  801a70:	e8 73 fc ff ff       	call   8016e8 <strchr>
  801a75:	85 c0                	test   %eax,%eax
  801a77:	75 d7                	jne    801a50 <gettoken+0x20>
        *s ++ = '\0';
    }
    if (*s == '\0') {
  801a79:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a7c:	0f b6 00             	movzbl (%eax),%eax
  801a7f:	84 c0                	test   %al,%al
  801a81:	75 0a                	jne    801a8d <gettoken+0x5d>
        return 0;
  801a83:	b8 00 00 00 00       	mov    $0x0,%eax
  801a88:	e9 b9 00 00 00       	jmp    801b46 <gettoken+0x116>
    }
  ...
  801a93:	89 10                	mov    %edx,(%eax)
    int token = 'w';
  801a95:	c7 45 f0 77 00 00 00 	movl   $0x77,-0x10(%ebp)
    if (strchr(SYMBOLS, *s) != NULL) {
  801a9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a9f:	0f b6 00             	movzbl (%eax),%eax
  801aa2:	0f be c0             	movsbl %al,%eax
  801aa5:	89 44 24 04          	mov    %eax,0x4(%esp)
  801aa9:	c7 04 24 e5 26 80 00 	movl   $0x8026e5,(%esp)
  801ab0:	e8 33 fc ff ff       	call   8016e8 <strchr>
  801ab5:	85 c0                	test   %eax,%eax
  801ab7:	74 1a                	je     801ad3 <gettoken+0xa3>
        token = *s, *s ++ = '\0';
  801ab9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801abc:	0f b6 00             	movzbl (%eax),%eax
  ...
  801acb:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801ace:	c6 00 00             	movb   $0x0,(%eax)
  801ad1:	eb 57                	jmp    801b2a <gettoken+0xfa>
    }
    else {
        bool flag = 0;
  801ad3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
        while (*s != '\0' && (flag || strchr(WHITESPACE SYMBOLS, *s) == NULL)) {
  801ada:	eb 21                	jmp    801afd <gettoken+0xcd>
            if (*s == '"') {
  801adc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801adf:	0f b6 00             	movzbl (%eax),%eax
  801ae2:	3c 22                	cmp    $0x22,%al
  801ae4:	75 13                	jne    801af9 <gettoken+0xc9>
                *s = ' ', flag = !flag;
  801ae6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ae9:	c6 00 20             	movb   $0x20,(%eax)
  801aec:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801af0:	0f 94 c0             	sete   %al
  801af3:	0f b6 c0             	movzbl %al,%eax
  801af6:	89 45 ec             	mov    %eax,-0x14(%ebp)
            }
            s ++;
  801af9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    if (strchr(SYMBOLS, *s) != NULL) {
        token = *s, *s ++ = '\0';
    }
    else {
  ...
  801b00:	0f b6 00             	movzbl (%eax),%eax
  801b03:	84 c0                	test   %al,%al
  801b05:	74 23                	je     801b2a <gettoken+0xfa>
  801b07:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801b0b:	75 cf                	jne    801adc <gettoken+0xac>
  801b0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b10:	0f b6 00             	movzbl (%eax),%eax
  801b13:	0f be c0             	movsbl %al,%eax
  801b16:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b1a:	c7 04 24 eb 26 80 00 	movl   $0x8026eb,(%esp)
  801b21:	e8 c2 fb ff ff       	call   8016e8 <strchr>
  801b26:	85 c0                	test   %eax,%eax
  801b28:	74 b2                	je     801adc <gettoken+0xac>
                *s = ' ', flag = !flag;
            }
            s ++;
        }
  ...
  801b2d:	0f b6 00             	movzbl (%eax),%eax
  801b30:	84 c0                	test   %al,%al
  801b32:	74 05                	je     801b39 <gettoken+0x109>
  801b34:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b37:	eb 05                	jmp    801b3e <gettoken+0x10e>
  801b39:	b8 00 00 00 00       	mov    $0x0,%eax
  801b3e:	8b 55 08             	mov    0x8(%ebp),%edx
  801b41:	89 02                	mov    %eax,(%edx)
    return token;
...
readline(const char *prompt) {
  ...
  801b4b:	83 ec 28             	sub    $0x28,%esp
    static char buffer[BUFSIZE];
    if (prompt != NULL) {
  801b4e:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  801b52:	74 1b                	je     801b6f <readline+0x27>
        printf("%s", prompt);
  801b54:	8b 45 08             	mov    0x8(%ebp),%eax
  801b57:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b5b:	c7 44 24 04 f5 26 80 	movl   $0x8026f5,0x4(%esp)
  801b62:	00 
  801b63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b6a:	e8 ac e9 ff ff       	call   80051b <fprintf>
    }
    int ret, i = 0;
  ...
  801b76:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  801b7d:	00 
  801b7e:	8d 45 ef             	lea    -0x11(%ebp),%eax
  801b81:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b85:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801b8c:	e8 d4 e5 ff ff       	call   800165 <read>
  801b91:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801b94:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801b98:	79 0a                	jns    801ba4 <readline+0x5c>
            return NULL;
  801b9a:	b8 00 00 00 00       	mov    $0x0,%eax
  801b9f:	e9 f6 00 00 00       	jmp    801c9a <readline+0x152>
        }
        else if (ret == 0) {
  801ba4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801ba8:	75 20                	jne    801bca <readline+0x82>
            if (i > 0) {
  801baa:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801bae:	7e 10                	jle    801bc0 <readline+0x78>
                buffer[i] = '\0';
  801bb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801bb3:	05 40 30 80 00       	add    $0x803040,%eax
  801bb8:	c6 00 00             	movb   $0x0,(%eax)
                break;
  801bbb:	e9 d5 00 00 00       	jmp    801c95 <readline+0x14d>
            }
            return NULL;
  801bc0:	b8 00 00 00 00       	mov    $0x0,%eax
  801bc5:	e9 d0 00 00 00       	jmp    801c9a <readline+0x152>
        }

        if (c == 3) {
  801bca:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801bce:	3c 03                	cmp    $0x3,%al
  801bd0:	75 0a                	jne    801bdc <readline+0x94>
            return NULL;
  801bd2:	b8 00 00 00 00       	mov    $0x0,%eax
  801bd7:	e9 be 00 00 00       	jmp    801c9a <readline+0x152>
        }
        else if (c >= ' ' && i < BUFSIZE - 1) {
  801bdc:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801be0:	3c 1f                	cmp    $0x1f,%al
  801be2:	7e 3d                	jle    801c21 <readline+0xd9>
  801be4:	81 7d f4 fe 0f 00 00 	cmpl   $0xffe,-0xc(%ebp)
  801beb:	7f 34                	jg     801c21 <readline+0xd9>
            putc(c);
  801bed:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801bf1:	0f be c0             	movsbl %al,%eax
  801bf4:	89 44 24 08          	mov    %eax,0x8(%esp)
  801bf8:	c7 44 24 04 f8 26 80 	movl   $0x8026f8,0x4(%esp)
  801bff:	00 
  801c00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c07:	e8 0f e9 ff ff       	call   80051b <fprintf>
            buffer[i ++] = c;
  801c0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c0f:	8d 50 01             	lea    0x1(%eax),%edx
  801c12:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801c15:	0f b6 55 ef          	movzbl -0x11(%ebp),%edx
  801c19:	88 90 40 30 80 00    	mov    %dl,0x803040(%eax)
  801c1f:	eb 6f                	jmp    801c90 <readline+0x148>
        }
        else if (c == '\b' && i > 0) {
  801c21:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801c25:	3c 08                	cmp    $0x8,%al
  801c27:	75 2b                	jne    801c54 <readline+0x10c>
  801c29:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801c2d:	7e 25                	jle    801c54 <readline+0x10c>
            putc(c);
  801c2f:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801c33:	0f be c0             	movsbl %al,%eax
  801c36:	89 44 24 08          	mov    %eax,0x8(%esp)
  801c3a:	c7 44 24 04 f8 26 80 	movl   $0x8026f8,0x4(%esp)
  801c41:	00 
  801c42:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c49:	e8 cd e8 ff ff       	call   80051b <fprintf>
            i --;
  801c4e:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
  801c52:	eb 3c                	jmp    801c90 <readline+0x148>
        }
        else if (c == '\n' || c == '\r') {
  801c54:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801c58:	3c 0a                	cmp    $0xa,%al
  801c5a:	74 08                	je     801c64 <readline+0x11c>
  801c5c:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801c60:	3c 0d                	cmp    $0xd,%al
  801c62:	75 2c                	jne    801c90 <readline+0x148>
            putc(c);
  801c64:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801c68:	0f be c0             	movsbl %al,%eax
  801c6b:	89 44 24 08          	mov    %eax,0x8(%esp)
  801c6f:	c7 44 24 04 f8 26 80 	movl   $0x8026f8,0x4(%esp)
  801c76:	00 
  801c77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c7e:	e8 98 e8 ff ff       	call   80051b <fprintf>
            buffer[i] = '\0';
  801c83:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c86:	05 40 30 80 00       	add    $0x803040,%eax
  801c8b:	c6 00 00             	movb   $0x0,(%eax)
            break;
  801c8e:	eb 05                	jmp    801c95 <readline+0x14d>
        }
    }
  801c90:	e9 e1 fe ff ff       	jmp    801b76 <readline+0x2e>
    return buffer;
  801c95:	b8 40 30 80 00       	mov    $0x803040,%eax
}
  801c9a:	c9                   	leave  
  801c9b:	c3                   	ret    
...
usage(void) {
  ...
  801ca2:	c7 44 24 04 fb 26 80 	movl   $0x8026fb,0x4(%esp)
  801ca9:	00 
  801caa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cb1:	e8 65 e8 ff ff       	call   80051b <fprintf>
}
  801cb6:	c9                   	leave  
  801cb7:	c3                   	ret    
...
reopen(int fd2, const char *filename, uint32_t open_flags) {
  ...
  801cc4:	e8 89 e4 ff ff       	call   800152 <close>
  ...
  801cd6:	e8 43 e4 ff ff       	call   80011e <open>
  801cdb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801cde:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801ce2:	78 39                	js     801d1d <reopen+0x65>
  801ce4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ce7:	3b 45 08             	cmp    0x8(%ebp),%eax
  801cea:	74 31                	je     801d1d <reopen+0x65>
        close(fd2);
  801cec:	8b 45 08             	mov    0x8(%ebp),%eax
  801cef:	89 04 24             	mov    %eax,(%esp)
  801cf2:	e8 5b e4 ff ff       	call   800152 <close>
...
runcmd(char *cmd) {
  ...
  801d68:	81 ec b8 00 00 00    	sub    $0xb8,%esp
...
again:
  ...
  801d75:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801d7b:	89 44 24 04          	mov    %eax,0x4(%esp)
  801d7f:	8d 45 08             	lea    0x8(%ebp),%eax
  801d82:	89 04 24             	mov    %eax,(%esp)
  801d85:	e8 a6 fc ff ff       	call   801a30 <gettoken>
  801d8a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801d8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801d90:	83 f8 3c             	cmp    $0x3c,%eax
  801d93:	74 76                	je     801e0b <runcmd+0xa6>
  801d95:	83 f8 3c             	cmp    $0x3c,%eax
  801d98:	7f 16                	jg     801db0 <runcmd+0x4b>
  801d9a:	85 c0                	test   %eax,%eax
  801d9c:	0f 84 62 02 00 00    	je     802004 <runcmd+0x29f>
  801da2:	83 f8 3b             	cmp    $0x3b,%eax
  801da5:	0f 84 f9 01 00 00    	je     801fa4 <runcmd+0x23f>
  801dab:	e9 2a 02 00 00       	jmp    801fda <runcmd+0x275>
  801db0:	83 f8 77             	cmp    $0x77,%eax
  801db3:	74 17                	je     801dcc <runcmd+0x67>
  801db5:	83 f8 7c             	cmp    $0x7c,%eax
  801db8:	0f 84 25 01 00 00    	je     801ee3 <runcmd+0x17e>
  801dbe:	83 f8 3e             	cmp    $0x3e,%eax
  801dc1:	0f 84 b0 00 00 00    	je     801e77 <runcmd+0x112>
  801dc7:	e9 0e 02 00 00       	jmp    801fda <runcmd+0x275>
        case 'w':
            if (argc == EXEC_MAX_ARG_NUM) {
  801dcc:	83 7d f4 20          	cmpl   $0x20,-0xc(%ebp)
  801dd0:	75 1e                	jne    801df0 <runcmd+0x8b>
                printf("sh error: too many arguments\n");
  801dd2:	c7 44 24 04 15 27 80 	movl   $0x802715,0x4(%esp)
  801dd9:	00 
  801dda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801de1:	e8 35 e7 ff ff       	call   80051b <fprintf>
                return -1;
  801de6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801deb:	e9 3e 03 00 00       	jmp    80212e <runcmd+0x3c9>
            }
            argv[argc ++] = t;
  801df0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801df3:	8d 50 01             	lea    0x1(%eax),%edx
  801df6:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801df9:	8b 95 64 ff ff ff    	mov    -0x9c(%ebp),%edx
  801dff:	89 94 85 68 ff ff ff 	mov    %edx,-0x98(%ebp,%eax,4)
            break;
  801e06:	e9 f4 01 00 00       	jmp    801fff <runcmd+0x29a>
        case '<':
            if (gettoken(&cmd, &t) != 'w') {
  801e0b:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801e11:	89 44 24 04          	mov    %eax,0x4(%esp)
  801e15:	8d 45 08             	lea    0x8(%ebp),%eax
  801e18:	89 04 24             	mov    %eax,(%esp)
  801e1b:	e8 10 fc ff ff       	call   801a30 <gettoken>
  801e20:	83 f8 77             	cmp    $0x77,%eax
  801e23:	74 1e                	je     801e43 <runcmd+0xde>
                printf("sh error: syntax error: < not followed by word\n");
  801e25:	c7 44 24 04 34 27 80 	movl   $0x802734,0x4(%esp)
  801e2c:	00 
  801e2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801e34:	e8 e2 e6 ff ff       	call   80051b <fprintf>
                return -1;
  801e39:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801e3e:	e9 eb 02 00 00       	jmp    80212e <runcmd+0x3c9>
            }
            if ((ret = reopen(0, t, O_RDONLY)) != 0) {
  801e43:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
  801e49:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801e50:	00 
  801e51:	89 44 24 04          	mov    %eax,0x4(%esp)
  801e55:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801e5c:	e8 57 fe ff ff       	call   801cb8 <reopen>
  801e61:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801e64:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801e68:	74 08                	je     801e72 <runcmd+0x10d>
                return ret;
  801e6a:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801e6d:	e9 bc 02 00 00       	jmp    80212e <runcmd+0x3c9>
            }
            break;
  801e72:	e9 88 01 00 00       	jmp    801fff <runcmd+0x29a>
        case '>':
            if (gettoken(&cmd, &t) != 'w') {
  801e77:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801e7d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801e81:	8d 45 08             	lea    0x8(%ebp),%eax
  801e84:	89 04 24             	mov    %eax,(%esp)
  801e87:	e8 a4 fb ff ff       	call   801a30 <gettoken>
  801e8c:	83 f8 77             	cmp    $0x77,%eax
  801e8f:	74 1e                	je     801eaf <runcmd+0x14a>
                printf("sh error: syntax error: > not followed by word\n");
  801e91:	c7 44 24 04 64 27 80 	movl   $0x802764,0x4(%esp)
  801e98:	00 
  801e99:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ea0:	e8 76 e6 ff ff       	call   80051b <fprintf>
                return -1;
  801ea5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801eaa:	e9 7f 02 00 00       	jmp    80212e <runcmd+0x3c9>
            }
            if ((ret = reopen(1, t, O_RDWR | O_TRUNC | O_CREAT)) != 0) {
  801eaf:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
  801eb5:	c7 44 24 08 16 00 00 	movl   $0x16,0x8(%esp)
  801ebc:	00 
  801ebd:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ec1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ec8:	e8 eb fd ff ff       	call   801cb8 <reopen>
  801ecd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801ed0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801ed4:	74 08                	je     801ede <runcmd+0x179>
                return ret;
  801ed6:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801ed9:	e9 50 02 00 00       	jmp    80212e <runcmd+0x3c9>
            }
            break;
  801ede:	e9 1c 01 00 00       	jmp    801fff <runcmd+0x29a>
        case '|':
          //  if ((ret = pipe(p)) != 0) {
          //      return ret;
          //  }
            if ((ret = fork()) == 0) {
  801ee3:	e8 b0 eb ff ff       	call   800a98 <fork>
  801ee8:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801eeb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801eef:	75 54                	jne    801f45 <runcmd+0x1e0>
                close(0);
  801ef1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801ef8:	e8 55 e2 ff ff       	call   800152 <close>
                if ((ret = dup2(p[0], 0)) < 0) {
  801efd:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801f03:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801f0a:	00 
  801f0b:	89 04 24             	mov    %eax,(%esp)
  801f0e:	e8 e2 e2 ff ff       	call   8001f5 <dup2>
  801f13:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801f16:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801f1a:	79 08                	jns    801f24 <runcmd+0x1bf>
                    return ret;
  801f1c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f1f:	e9 0a 02 00 00       	jmp    80212e <runcmd+0x3c9>
                }
                close(p[0]), close(p[1]);
  801f24:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801f2a:	89 04 24             	mov    %eax,(%esp)
  801f2d:	e8 20 e2 ff ff       	call   800152 <close>
  801f32:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801f38:	89 04 24             	mov    %eax,(%esp)
  801f3b:	e8 12 e2 ff ff       	call   800152 <close>
                goto again;
  801f40:	e9 29 fe ff ff       	jmp    801d6e <runcmd+0x9>
            }
            else {
                if (ret < 0) {
  801f45:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801f49:	79 08                	jns    801f53 <runcmd+0x1ee>
                    return ret;
  801f4b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f4e:	e9 db 01 00 00       	jmp    80212e <runcmd+0x3c9>
                }
                close(1);
  801f53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801f5a:	e8 f3 e1 ff ff       	call   800152 <close>
                if ((ret = dup2(p[1], 1)) < 0) {
  801f5f:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801f65:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  801f6c:	00 
  801f6d:	89 04 24             	mov    %eax,(%esp)
  801f70:	e8 80 e2 ff ff       	call   8001f5 <dup2>
  801f75:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801f78:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801f7c:	79 08                	jns    801f86 <runcmd+0x221>
                    return ret;
  801f7e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f81:	e9 a8 01 00 00       	jmp    80212e <runcmd+0x3c9>
                }
                close(p[0]), close(p[1]);
  801f86:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801f8c:	89 04 24             	mov    %eax,(%esp)
  801f8f:	e8 be e1 ff ff       	call   800152 <close>
  801f94:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801f9a:	89 04 24             	mov    %eax,(%esp)
  801f9d:	e8 b0 e1 ff ff       	call   800152 <close>
                goto runit;
  801fa2:	eb 61                	jmp    802005 <runcmd+0x2a0>
            }
            break;
        case 0:
            goto runit;
        case ';':
            if ((ret = fork()) == 0) {
  801fa4:	e8 ef ea ff ff       	call   800a98 <fork>
  801fa9:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801fac:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801fb0:	75 02                	jne    801fb4 <runcmd+0x24f>
                goto runit;
  801fb2:	eb 51                	jmp    802005 <runcmd+0x2a0>
            }
            else {
                if (ret < 0) {
  801fb4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801fb8:	79 08                	jns    801fc2 <runcmd+0x25d>
                    return ret;
  801fba:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801fbd:	e9 6c 01 00 00       	jmp    80212e <runcmd+0x3c9>
                }
                waitpid(ret, NULL);
  ...
  801fd0:	e8 ec ea ff ff       	call   800ac1 <waitpid>
                goto again;
  801fd5:	e9 94 fd ff ff       	jmp    801d6e <runcmd+0x9>
            }
            break;
        default:
  ...
  801fe1:	c7 44 24 04 94 27 80 	movl   $0x802794,0x4(%esp)
  801fe8:	00 
  801fe9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ff0:	e8 26 e5 ff ff       	call   80051b <fprintf>
            return -1;
  801ff5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801ffa:	e9 2f 01 00 00       	jmp    80212e <runcmd+0x3c9>
        }
    }
  801fff:	e9 71 fd ff ff       	jmp    801d75 <runcmd+0x10>
                close(p[0]), close(p[1]);
                goto runit;
            }
            break;
...
runit:
  ...
  802009:	75 0a                	jne    802015 <runcmd+0x2b0>
        return 0;
  80200b:	b8 00 00 00 00       	mov    $0x0,%eax
  802010:	e9 19 01 00 00       	jmp    80212e <runcmd+0x3c9>
    }
    else if (strcmp(argv[0], "cd") == 0) {
  802015:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  80201b:	c7 44 24 04 bb 27 80 	movl   $0x8027bb,0x4(%esp)
  802022:	00 
  802023:	89 04 24             	mov    %eax,(%esp)
  802026:	e8 1e f6 ff ff       	call   801649 <strcmp>
  80202b:	85 c0                	test   %eax,%eax
  80202d:	75 4c                	jne    80207b <runcmd+0x316>
        if (argc != 2) {
  80202f:	83 7d f4 02          	cmpl   $0x2,-0xc(%ebp)
  802033:	74 0a                	je     80203f <runcmd+0x2da>
            return -1;
  802035:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  80203a:	e9 ef 00 00 00       	jmp    80212e <runcmd+0x3c9>
        }
        strcpy(shcwd, argv[1]);
  80203f:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
  802045:	89 44 24 04          	mov    %eax,0x4(%esp)
  802049:	c7 04 24 60 51 80 00 	movl   $0x805160,(%esp)
  802050:	e8 7b f5 ff ff       	call   8015d0 <strcpy>
        printf("pwd: %s\n", shcwd);
  802055:	c7 44 24 08 60 51 80 	movl   $0x805160,0x8(%esp)
  80205c:	00 
  80205d:	c7 44 24 04 be 27 80 	movl   $0x8027be,0x4(%esp)
  802064:	00 
  802065:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80206c:	e8 aa e4 ff ff       	call   80051b <fprintf>
        return 0;
  802071:	b8 00 00 00 00       	mov    $0x0,%eax
  802076:	e9 b3 00 00 00       	jmp    80212e <runcmd+0x3c9>
    }
    else if(strcmp(argv[0], "pwd") == 0){
  80207b:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  802081:	c7 44 24 04 c7 27 80 	movl   $0x8027c7,0x4(%esp)
  802088:	00 
  802089:	89 04 24             	mov    %eax,(%esp)
  80208c:	e8 b8 f5 ff ff       	call   801649 <strcmp>
  802091:	85 c0                	test   %eax,%eax
  802093:	75 23                	jne    8020b8 <runcmd+0x353>
        printf("pwd: %s\n", shcwd);
  802095:	c7 44 24 08 60 51 80 	movl   $0x805160,0x8(%esp)
  80209c:	00 
  80209d:	c7 44 24 04 be 27 80 	movl   $0x8027be,0x4(%esp)
  8020a4:	00 
  8020a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8020ac:	e8 6a e4 ff ff       	call   80051b <fprintf>
        return 0;
  8020b1:	b8 00 00 00 00       	mov    $0x0,%eax
  8020b6:	eb 76                	jmp    80212e <runcmd+0x3c9>
    }
    if ((ret = testfile(argv[0])) != 0) {
  8020b8:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  8020be:	89 04 24             	mov    %eax,(%esp)
  8020c1:	e8 66 fc ff ff       	call   801d2c <testfile>
  8020c6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8020c9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8020cd:	74 3b                	je     80210a <runcmd+0x3a5>
        if (ret != -E_NOENT) {
  8020cf:	83 7d ec f0          	cmpl   $0xfffffff0,-0x14(%ebp)
  8020d3:	74 05                	je     8020da <runcmd+0x375>
            return ret;
  8020d5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020d8:	eb 54                	jmp    80212e <runcmd+0x3c9>
        }
        snprintf(argv0, sizeof(argv0), "/%s", argv[0]);
  8020da:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  8020e0:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8020e4:	c7 44 24 08 cb 27 80 	movl   $0x8027cb,0x8(%esp)
  8020eb:	00 
  8020ec:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
  8020f3:	00 
  8020f4:	c7 04 24 40 40 80 00 	movl   $0x804040,(%esp)
  8020fb:	e8 d9 f2 ff ff       	call   8013d9 <snprintf>
        argv[0] = argv0;
  802100:	c7 85 68 ff ff ff 40 	movl   $0x804040,-0x98(%ebp)
  802107:	40 80 00 
    }
    argv[argc] = NULL;
  80210a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80210d:	c7 84 85 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%eax,4)
  802114:	00 00 00 00 
    return __exec(NULL, argv);
  802118:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  80211e:	89 44 24 04          	mov    %eax,0x4(%esp)
  802122:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  802129:	e8 1a ea ff ff       	call   800b48 <__exec>
}
  80212e:	c9                   	leave  
  80212f:	c3                   	ret    
...
main(int argc, char **argv) {
  ...
  802133:	83 e4 f0             	and    $0xfffffff0,%esp
  802136:	83 ec 20             	sub    $0x20,%esp
    printf("user sh is running!!!\n");
  802139:	c7 44 24 04 cf 27 80 	movl   $0x8027cf,0x4(%esp)
  802140:	00 
  802141:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  802148:	e8 ce e3 ff ff       	call   80051b <fprintf>
    int ret, interactive = 1;
  80214d:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  802154:	00 
    // }
  ...
  802155:	e9 b6 00 00 00       	jmp    802210 <main+0xe0>

        //get_cwd_nolock();
        int pid;
        if ((pid = fork()) == 0) {
  80215a:	e8 39 e9 ff ff       	call   800a98 <fork>
  80215f:	89 44 24 14          	mov    %eax,0x14(%esp)
  802163:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  802168:	75 1c                	jne    802186 <main+0x56>
            ret = runcmd(buffer);
  80216a:	8b 44 24 18          	mov    0x18(%esp),%eax
  80216e:	89 04 24             	mov    %eax,(%esp)
  802171:	e8 ef fb ff ff       	call   801d65 <runcmd>
  802176:	89 44 24 10          	mov    %eax,0x10(%esp)
            exit (ret);
  80217a:	8b 44 24 10          	mov    0x10(%esp),%eax
  80217e:	89 04 24             	mov    %eax,(%esp)
  802181:	e8 f3 e8 ff ff       	call   800a79 <exit>
        }
        assert(pid >= 0);
  802186:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  80218b:	79 24                	jns    8021b1 <main+0x81>
  80218d:	c7 44 24 0c e6 27 80 	movl   $0x8027e6,0xc(%esp)
  802194:	00 
  802195:	c7 44 24 08 ef 27 80 	movl   $0x8027ef,0x8(%esp)
  80219c:	00 
  80219d:	c7 44 24 04 f8 00 00 	movl   $0xf8,0x4(%esp)
  8021a4:	00 
  8021a5:	c7 04 24 04 28 80 00 	movl   $0x802804,(%esp)
  8021ac:	e8 95 e1 ff ff       	call   800346 <__panic>
        if (waitpid(pid, &ret) == 0) {
  8021b1:	8d 44 24 10          	lea    0x10(%esp),%eax
  8021b5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8021b9:	8b 44 24 14          	mov    0x14(%esp),%eax
  8021bd:	89 04 24             	mov    %eax,(%esp)
  8021c0:	e8 fc e8 ff ff       	call   800ac1 <waitpid>
  8021c5:	85 c0                	test   %eax,%eax
  8021c7:	75 47                	jne    802210 <main+0xe0>
            if (ret == 0 && shcwd[0] != '\0') {
  8021c9:	8b 44 24 10          	mov    0x10(%esp),%eax
  8021cd:	85 c0                	test   %eax,%eax
  8021cf:	75 13                	jne    8021e4 <main+0xb4>
  8021d1:	0f b6 05 60 51 80 00 	movzbl 0x805160,%eax
  8021d8:	84 c0                	test   %al,%al
  8021da:	74 08                	je     8021e4 <main+0xb4>
                ret = 0;
  8021dc:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%esp)
  8021e3:	00 
            }
            if (ret != 0) {
  8021e4:	8b 44 24 10          	mov    0x10(%esp),%eax
  8021e8:	85 c0                	test   %eax,%eax
  8021ea:	74 24                	je     802210 <main+0xe0>
                printf("error: %d - %e\n", ret, ret);
  8021ec:	8b 54 24 10          	mov    0x10(%esp),%edx
  8021f0:	8b 44 24 10          	mov    0x10(%esp),%eax
  8021f4:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8021f8:	89 44 24 08          	mov    %eax,0x8(%esp)
  8021fc:	c7 44 24 04 0e 28 80 	movl   $0x80280e,0x4(%esp)
  802203:	00 
  802204:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80220b:	e8 0b e3 ff ff       	call   80051b <fprintf>
    // }
    //shcwd = malloc(BUFSIZE);
    assert(shcwd != NULL);
    //printf("\n$ > ");
    char *buffer;
    while ((buffer = readline((interactive) ? "$ " : NULL)) != NULL) {
  802210:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  802215:	74 07                	je     80221e <main+0xee>
  802217:	b8 1e 28 80 00       	mov    $0x80281e,%eax
  80221c:	eb 05                	jmp    802223 <main+0xf3>
  80221e:	b8 00 00 00 00       	mov    $0x0,%eax
  802223:	89 04 24             	mov    %eax,(%esp)
  802226:	e8 1d f9 ff ff       	call   801b48 <readline>
  80222b:	89 44 24 18          	mov    %eax,0x18(%esp)
  80222f:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  802234:	0f 85 20 ff ff ff    	jne    80215a <main+0x2a>
            if (ret != 0) {
                printf("error: %d - %e\n", ret, ret);
            }
        }
