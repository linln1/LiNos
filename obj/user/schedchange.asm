...
obj/__user_schedchange.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 00 1b 80 00 	movl   $0x801b00,(%esp)
  ...
  8002de:	c7 04 24 0b 1b 80 00 	movl   $0x801b0b,(%esp)
  ...
  8002f4:	c7 04 24 1d 1b 80 00 	movl   $0x801b1d,(%esp)
  ...
  80030a:	c7 04 24 30 1b 80 00 	movl   $0x801b30,(%esp)
  ...
  800320:	c7 04 24 43 1b 80 00 	movl   $0x801b43,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 56 1b 80 00 	movl   $0x801b56,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 70 1b 80 00 	movl   $0x801b70,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 72 1b 80 00 	movl   $0x801b72,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 70 1b 80 00 	movl   $0x801b70,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 8e 1b 80 00 	movl   $0x801b8e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 a1 1b 80 	movl   $0x801ba1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 a8 1b 80 	movl   $0x801ba8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 c2 1b 80 00 	movl   $0x801bc2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 d4 1b 80 	movl   $0x801bd4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 dc 1b 80 	movl   $0x801bdc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 c2 1b 80 00 	movl   $0x801bc2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 04 1e 80 00       	add    $0x801e04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 28 1e 80 00 	mov    0x801e28(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 1e 1e 80 	movl   $0x801e1e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 21 1e 80 00       	mov    $0x801e21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(int argc, char **argv){
  ...
  801a36:	83 ec 10             	sub    $0x10,%esp
    if(argc !=  2){
  801a39:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801a3d:	74 19                	je     801a58 <main+0x28>
        printf("\nbad argument!\n");
  801a3f:	c7 44 24 04 80 1f 80 	movl   $0x801f80,0x4(%esp)
  801a46:	00 
  801a47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a4e:	e8 c8 ea ff ff       	call   80051b <fprintf>
  801a53:	e9 88 00 00 00       	jmp    801ae0 <main+0xb0>
    }
    else{
    	if(argv[1][0]=='1')
  ...
  801a60:	0f b6 00             	movzbl (%eax),%eax
  801a63:	3c 31                	cmp    $0x31,%al
  801a65:	75 0e                	jne    801a75 <main+0x45>
    	    change_sched(1);
  801a67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a6e:	e8 99 f1 ff ff       	call   800c0c <change_sched>
  801a73:	eb 6b                	jmp    801ae0 <main+0xb0>
    	else if(argv[1][0]=='2')	
  801a75:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a78:	83 c0 04             	add    $0x4,%eax
  801a7b:	8b 00                	mov    (%eax),%eax
  801a7d:	0f b6 00             	movzbl (%eax),%eax
  801a80:	3c 32                	cmp    $0x32,%al
  801a82:	75 0e                	jne    801a92 <main+0x62>
            change_sched(2);
  801a84:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  801a8b:	e8 7c f1 ff ff       	call   800c0c <change_sched>
  801a90:	eb 4e                	jmp    801ae0 <main+0xb0>
        else if(argv[1][0]=='3')	
  801a92:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a95:	83 c0 04             	add    $0x4,%eax
  801a98:	8b 00                	mov    (%eax),%eax
  801a9a:	0f b6 00             	movzbl (%eax),%eax
  801a9d:	3c 33                	cmp    $0x33,%al
  801a9f:	75 0e                	jne    801aaf <main+0x7f>
            change_sched(3);
  801aa1:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  801aa8:	e8 5f f1 ff ff       	call   800c0c <change_sched>
  801aad:	eb 31                	jmp    801ae0 <main+0xb0>
	else if(argv[1][0]=='4')
  801aaf:	8b 45 0c             	mov    0xc(%ebp),%eax
  801ab2:	83 c0 04             	add    $0x4,%eax
  801ab5:	8b 00                	mov    (%eax),%eax
  801ab7:	0f b6 00             	movzbl (%eax),%eax
  801aba:	3c 34                	cmp    $0x34,%al
  801abc:	75 0e                	jne    801acc <main+0x9c>
	    change_sched(4);
  801abe:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  801ac5:	e8 42 f1 ff ff       	call   800c0c <change_sched>
  801aca:	eb 14                	jmp    801ae0 <main+0xb0>
        else
            printf("\nbad argument!\n");
  801acc:	c7 44 24 04 80 1f 80 	movl   $0x801f80,0x4(%esp)
  801ad3:	00 
  801ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801adb:	e8 3b ea ff ff       	call   80051b <fprintf>
    }
    return 0;
