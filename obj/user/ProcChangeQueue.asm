...
obj/__user_ProcChangeQueue.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 c0 1a 80 00 	movl   $0x801ac0,(%esp)
  ...
  8002de:	c7 04 24 cb 1a 80 00 	movl   $0x801acb,(%esp)
  ...
  8002f4:	c7 04 24 dd 1a 80 00 	movl   $0x801add,(%esp)
  ...
  80030a:	c7 04 24 f0 1a 80 00 	movl   $0x801af0,(%esp)
  ...
  800320:	c7 04 24 03 1b 80 00 	movl   $0x801b03,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 16 1b 80 00 	movl   $0x801b16,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 30 1b 80 00 	movl   $0x801b30,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 32 1b 80 00 	movl   $0x801b32,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 30 1b 80 00 	movl   $0x801b30,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 4e 1b 80 00 	movl   $0x801b4e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 61 1b 80 	movl   $0x801b61,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 68 1b 80 	movl   $0x801b68,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 82 1b 80 00 	movl   $0x801b82,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 94 1b 80 	movl   $0x801b94,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 9c 1b 80 	movl   $0x801b9c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 82 1b 80 00 	movl   $0x801b82,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 c4 1d 80 00       	add    $0x801dc4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 e8 1d 80 00 	mov    0x801de8(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c de 1d 80 	movl   $0x801dde,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be e1 1d 80 00       	mov    $0x801de1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void)
{
  ...
  801a40:	00 
  801a41:	eb 68                	jmp    801aab <main+0x7b>
    {
    	if((pid=fork())==0)
  801a43:	e8 50 f0 ff ff       	call   800a98 <fork>
  801a48:	89 44 24 14          	mov    %eax,0x14(%esp)
  801a4c:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  801a51:	75 53                	jne    801aa6 <main+0x76>
    	{
    	    for(j=0;j<5;j++)
  801a53:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  801a5a:	00 
  801a5b:	eb 40                	jmp    801a9d <main+0x6d>
    	    {
    	        printf("%d queue:",getpid());
  801a5d:	e8 99 f0 ff ff       	call   800afb <getpid>
  801a62:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a66:	c7 44 24 04 40 1f 80 	movl   $0x801f40,0x4(%esp)
  801a6d:	00 
  801a6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a75:	e8 a1 ea ff ff       	call   80051b <fprintf>
	        getrunqueue();
  801a7a:	e8 1f f1 ff ff       	call   800b9e <getrunqueue>
	        printf("\n");
  801a7f:	c7 44 24 04 4a 1f 80 	movl   $0x801f4a,0x4(%esp)
  801a86:	00 
  801a87:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a8e:	e8 88 ea ff ff       	call   80051b <fprintf>
	        yield();
  801a93:	e8 43 f0 ff ff       	call   800adb <yield>
    int i,j,pid;
    for(i=0;i<5;i++)
    {
    	if((pid=fork())==0)
    	{
    	    for(j=0;j<5;j++)
  801a98:	83 44 24 18 01       	addl   $0x1,0x18(%esp)
  801a9d:	83 7c 24 18 04       	cmpl   $0x4,0x18(%esp)
  801aa2:	7e b9                	jle    801a5d <main+0x2d>
    	        printf("%d queue:",getpid());
	        getrunqueue();
	        printf("\n");
	        yield();
	    ...
	    break;
  801aa4:	eb 0c                	jmp    801ab2 <main+0x82>
...
main(void)
{
    int i,j,pid;
    for(i=0;i<5;i++)
  801aa6:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801aab:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801ab0:	7e 91                	jle    801a43 <main+0x13>
	    }
	    break;
	}
