...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 e0 1a 80 00 	movl   $0x801ae0,(%esp)
  ...
  8002de:	c7 04 24 eb 1a 80 00 	movl   $0x801aeb,(%esp)
  ...
  8002f4:	c7 04 24 fd 1a 80 00 	movl   $0x801afd,(%esp)
  ...
  80030a:	c7 04 24 10 1b 80 00 	movl   $0x801b10,(%esp)
  ...
  800320:	c7 04 24 23 1b 80 00 	movl   $0x801b23,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 36 1b 80 00 	movl   $0x801b36,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 50 1b 80 00 	movl   $0x801b50,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 52 1b 80 00 	movl   $0x801b52,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 50 1b 80 00 	movl   $0x801b50,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 6e 1b 80 00 	movl   $0x801b6e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 81 1b 80 	movl   $0x801b81,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 88 1b 80 	movl   $0x801b88,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 a2 1b 80 00 	movl   $0x801ba2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 b4 1b 80 	movl   $0x801bb4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 bc 1b 80 	movl   $0x801bbc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 a2 1b 80 00 	movl   $0x801ba2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 e4 1d 80 00       	add    $0x801de4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 08 1e 80 00 	mov    0x801e08(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c fe 1d 80 	movl   $0x801dfe,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 01 1e 80 00       	mov    $0x801e01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801a3e:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801a42:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a47:	75 18                	jne    801a61 <main+0x31>
        sleep(~0);
  801a49:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801a50:	e8 d3 f0 ff ff       	call   800b28 <sleep>
        exit(0xdead);
  801a55:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  801a5c:	e8 18 f0 ff ff       	call   800a79 <exit>
    }
    assert(pid > 0);
  801a61:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a66:	7f 24                	jg     801a8c <main+0x5c>
  801a68:	c7 44 24 0c 60 1f 80 	movl   $0x801f60,0xc(%esp)
  801a6f:	00 
  801a70:	c7 44 24 08 68 1f 80 	movl   $0x801f68,0x8(%esp)
  801a77:	00 
  801a78:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  801a7f:	00 
  801a80:	c7 04 24 7d 1f 80 00 	movl   $0x801f7d,(%esp)
  801a87:	e8 ba e8 ff ff       	call   800346 <__panic>

    sleep(100);
  801a8c:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  801a93:	e8 90 f0 ff ff       	call   800b28 <sleep>
    assert(kill(pid) == 0);
  801a98:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a9c:	89 04 24             	mov    %eax,(%esp)
  801a9f:	e8 44 f0 ff ff       	call   800ae8 <kill>
  801aa4:	85 c0                	test   %eax,%eax
  801aa6:	74 24                	je     801acc <main+0x9c>
  801aa8:	c7 44 24 0c 8e 1f 80 	movl   $0x801f8e,0xc(%esp)
  801aaf:	00 
  801ab0:	c7 44 24 08 68 1f 80 	movl   $0x801f68,0x8(%esp)
  801ab7:	00 
  801ab8:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801abf:	00 
  801ac0:	c7 04 24 7d 1f 80 00 	movl   $0x801f7d,(%esp)
  801ac7:	e8 7a e8 ff ff       	call   800346 <__panic>
    cprintf("sleepkill pass.\n");
  801acc:	c7 04 24 9d 1f 80 00 	movl   $0x801f9d,(%esp)
