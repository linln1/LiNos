...
obj/__user_cpwd.out：     文件格式 elf32-i386
...
int main(){
  ...
  801a36:	83 ec 50             	sub    $0x50,%esp
	char buffer[64];
	getcwd(&buffer, 30);
  801a39:	c7 44 24 04 1e 00 00 	movl   $0x1e,0x4(%esp)
  801a40:	00 
  801a41:	8d 44 24 10          	lea    0x10(%esp),%eax
  801a45:	89 04 24             	mov    %eax,(%esp)
  801a48:	e8 a4 e6 ff ff       	call   8000f1 <getcwd>
	printf("current path = %s\n", buffer);
  801a4d:	8d 44 24 10          	lea    0x10(%esp),%eax
  801a51:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a55:	c7 44 24 04 00 1f 80 	movl   $0x801f00,0x4(%esp)
  801a5c:	00 
  801a5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a64:	e8 b2 ea ff ff       	call   80051b <fprintf>
	return 0;
