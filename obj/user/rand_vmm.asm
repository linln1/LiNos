...
obj/__user_rand_vmm.out：     文件格式 elf32-i386
...
int main(){
  ...
  801a36:	83 ec 20             	sub    $0x20,%esp
	...
	int seq_num = rand()%10;
  801a39:	e8 3b fa ff ff       	call   801479 <rand>
  801a3e:	89 c1                	mov    %eax,%ecx
  801a40:	ba 67 66 66 66       	mov    $0x66666667,%edx
  801a45:	89 c8                	mov    %ecx,%eax
  801a47:	f7 ea                	imul   %edx
  801a49:	c1 fa 02             	sar    $0x2,%edx
  801a4c:	89 c8                	mov    %ecx,%eax
  801a4e:	c1 f8 1f             	sar    $0x1f,%eax
  801a51:	29 c2                	sub    %eax,%edx
  801a53:	89 d0                	mov    %edx,%eax
  801a55:	89 44 24 10          	mov    %eax,0x10(%esp)
  801a59:	8b 54 24 10          	mov    0x10(%esp),%edx
  ...
  801a6e:	8b 44 24 10          	mov    0x10(%esp),%eax
  801a72:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a76:	c7 04 24 a0 1f 80 00 	movl   $0x801fa0,(%esp)
  801a7d:	e8 b5 e9 ff ff       	call   800437 <cprintf>

	int mem_seq;
	int i = 0;
  801a82:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  801a89:	00 
	int ret = 0;
  801a8a:	c7 44 24 14 00 00 00 	movl   $0x0,0x14(%esp)
  801a91:	00 
	for(; i < seq_num; i++){
  801a92:	eb 59                	jmp    801aed <main+0xbd>
		mem_seq = rand();
  801a94:	e8 e0 f9 ff ff       	call   801479 <rand>
  801a99:	89 44 24 1c          	mov    %eax,0x1c(%esp)
		
		while(mem_seq >= 32*1024 || mem_seq <= 4*1024){
  801a9d:	eb 09                	jmp    801aa8 <main+0x78>
			mem_seq = rand();
  801a9f:	e8 d5 f9 ff ff       	call   801479 <rand>
  801aa4:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	int i = 0;
	int ret = 0;
	for(; i < seq_num; i++){
		mem_seq = rand();
		...
		while(mem_seq >= 32*1024 || mem_seq <= 4*1024){
  801aa8:	81 7c 24 1c ff 7f 00 	cmpl   $0x7fff,0x1c(%esp)
  801aaf:	00 
  801ab0:	7f ed                	jg     801a9f <main+0x6f>
  801ab2:	81 7c 24 1c 00 10 00 	cmpl   $0x1000,0x1c(%esp)
  801ab9:	00 
  801aba:	7e e3                	jle    801a9f <main+0x6f>
			mem_seq = rand();
		}
  ...
  801ac4:	8b 44 24 18          	mov    0x18(%esp),%eax
  801ac8:	89 44 24 04          	mov    %eax,0x4(%esp)
  801acc:	c7 04 24 bc 1f 80 00 	movl   $0x801fbc,(%esp)
  801ad3:	e8 5f e9 ff ff       	call   800437 <cprintf>
		ret = malloc(mem_seq);
  801ad8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801adc:	89 04 24             	mov    %eax,(%esp)
  801adf:	e8 a7 f0 ff ff       	call   800b8b <malloc>
  801ae4:	89 44 24 14          	mov    %eax,0x14(%esp)
	cprintf("alloc memory for %d times\n", seq_num);
	...
	int ret = 0;
	for(; i < seq_num; i++){
  801ae8:	83 44 24 18 01       	addl   $0x1,0x18(%esp)
  801aed:	8b 44 24 18          	mov    0x18(%esp),%eax
  801af1:	3b 44 24 10          	cmp    0x10(%esp),%eax
  801af5:	7c 9d                	jl     801a94 <main+0x64>
		}
	...
	cprintf("ret is %d \n", ret);
  801af7:	8b 44 24 14          	mov    0x14(%esp),%eax
  801afb:	89 44 24 04          	mov    %eax,0x4(%esp)
  801aff:	c7 04 24 df 1f 80 00 	movl   $0x801fdf,(%esp)
  801b06:	e8 2c e9 ff ff       	call   800437 <cprintf>
	return 0;
