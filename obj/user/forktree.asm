...
umain(int argc, char *argv[]) {
  ...
  800d3a:	e8 a8 0d 00 00       	call   801ae7 <main>
...
forkchild(const char *cur, char branch) {
  ...
  801a33:	83 ec 38             	sub    $0x38,%esp
  801a36:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a39:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  801a3c:	8b 45 08             	mov    0x8(%ebp),%eax
  801a3f:	89 04 24             	mov    %eax,(%esp)
  801a42:	e8 0a fb ff ff       	call   801551 <strlen>
  801a47:	83 f8 03             	cmp    $0x3,%eax
  801a4a:	77 4f                	ja     801a9b <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801a4c:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  801a50:	89 44 24 10          	mov    %eax,0x10(%esp)
  801a54:	8b 45 08             	mov    0x8(%ebp),%eax
  801a57:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801a5b:	c7 44 24 08 c0 1f 80 	movl   $0x801fc0,0x8(%esp)
  801a62:	00 
  801a63:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  801a6a:	00 
  801a6b:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801a6e:	89 04 24             	mov    %eax,(%esp)
  801a71:	e8 63 f9 ff ff       	call   8013d9 <snprintf>
    if (fork() == 0) {
  801a76:	e8 1d f0 ff ff       	call   800a98 <fork>
  801a7b:	85 c0                	test   %eax,%eax
  801a7d:	75 1c                	jne    801a9b <forkchild+0x6b>
        forktree(nxt);
  801a7f:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801a82:	89 04 24             	mov    %eax,(%esp)
  801a85:	e8 13 00 00 00       	call   801a9d <forktree>
        yield();
  801a8a:	e8 4c f0 ff ff       	call   800adb <yield>
        exit(0);
  801a8f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801a96:	e8 de ef ff ff       	call   800a79 <exit>
    }
}
  801a9b:	c9                   	leave  
  801a9c:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  801aa0:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801aa3:	e8 53 f0 ff ff       	call   800afb <getpid>
  801aa8:	8b 55 08             	mov    0x8(%ebp),%edx
  801aab:	89 54 24 08          	mov    %edx,0x8(%esp)
  801aaf:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ab3:	c7 04 24 c5 1f 80 00 	movl   $0x801fc5,(%esp)
  801aba:	e8 78 e9 ff ff       	call   800437 <cprintf>

    forkchild(cur, '0');
  801abf:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801ac6:	00 
  801ac7:	8b 45 08             	mov    0x8(%ebp),%eax
  801aca:	89 04 24             	mov    %eax,(%esp)
  801acd:	e8 5e ff ff ff       	call   801a30 <forkchild>
    forkchild(cur, '1');
  801ad2:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801ad9:	00 
  801ada:	8b 45 08             	mov    0x8(%ebp),%eax
  801add:	89 04 24             	mov    %eax,(%esp)
  801ae0:	e8 4b ff ff ff       	call   801a30 <forkchild>
}
  801ae5:	c9                   	leave  
  801ae6:	c3                   	ret    
...
main(void) {
  ...
  801aea:	83 e4 f0             	and    $0xfffffff0,%esp
  801aed:	83 ec 10             	sub    $0x10,%esp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  801af0:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801af7:	00 
  801af8:	c7 04 24 d8 1f 80 00 	movl   $0x801fd8,(%esp)
  801aff:	e8 33 e9 ff ff       	call   800437 <cprintf>
    sleep(SLEEP_TIME);
  801b04:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801b0b:	e8 18 f0 ff ff       	call   800b28 <sleep>
    forktree("");
  801b10:	c7 04 24 fe 1f 80 00 	movl   $0x801ffe,(%esp)
  801b17:	e8 81 ff ff ff       	call   801a9d <forktree>
    return 0;
