...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 a0 1b 80 00 	movl   $0x801ba0,(%esp)
  ...
  8002de:	c7 04 24 ab 1b 80 00 	movl   $0x801bab,(%esp)
  ...
  8002f4:	c7 04 24 bd 1b 80 00 	movl   $0x801bbd,(%esp)
  ...
  80030a:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
  ...
  800320:	c7 04 24 e3 1b 80 00 	movl   $0x801be3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 f6 1b 80 00 	movl   $0x801bf6,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 10 1c 80 00 	movl   $0x801c10,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 12 1c 80 00 	movl   $0x801c12,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 10 1c 80 00 	movl   $0x801c10,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 2e 1c 80 00 	movl   $0x801c2e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 41 1c 80 	movl   $0x801c41,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 48 1c 80 	movl   $0x801c48,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 62 1c 80 00 	movl   $0x801c62,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 74 1c 80 	movl   $0x801c74,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 7c 1c 80 	movl   $0x801c7c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 62 1c 80 00 	movl   $0x801c62,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 a4 1e 80 00       	add    $0x801ea4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 c8 1e 80 00 	mov    0x801ec8(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c be 1e 80 	movl   $0x801ebe,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be c1 1e 80 00       	mov    $0x801ec1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801a39:	c7 04 24 20 20 80 00 	movl   $0x802020,(%esp)
  801a40:	e8 f2 e9 ff ff       	call   800437 <cprintf>
    if ((pid = fork()) == 0) {
  801a45:	e8 4e f0 ff ff       	call   800a98 <fork>
  801a4a:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801a4e:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a53:	75 3c                	jne    801a91 <main+0x61>
        cprintf("I am the child.\n");
  801a55:	c7 04 24 47 20 80 00 	movl   $0x802047,(%esp)
  801a5c:	e8 d6 e9 ff ff       	call   800437 <cprintf>
        yield();
  801a61:	e8 75 f0 ff ff       	call   800adb <yield>
        yield();
  801a66:	e8 70 f0 ff ff       	call   800adb <yield>
        yield();
  801a6b:	e8 6b f0 ff ff       	call   800adb <yield>
        yield();
  801a70:	e8 66 f0 ff ff       	call   800adb <yield>
        yield();
  801a75:	e8 61 f0 ff ff       	call   800adb <yield>
        yield();
  801a7a:	e8 5c f0 ff ff       	call   800adb <yield>
        yield();
  801a7f:	e8 57 f0 ff ff       	call   800adb <yield>
        exit(magic);
  801a84:	a1 10 30 80 00       	mov    0x803010,%eax
  801a89:	89 04 24             	mov    %eax,(%esp)
  801a8c:	e8 e8 ef ff ff       	call   800a79 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801a91:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a95:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a99:	c7 04 24 58 20 80 00 	movl   $0x802058,(%esp)
  801aa0:	e8 92 e9 ff ff       	call   800437 <cprintf>
    }
    assert(pid > 0);
  801aa5:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801aaa:	7f 24                	jg     801ad0 <main+0xa0>
  801aac:	c7 44 24 0c 7a 20 80 	movl   $0x80207a,0xc(%esp)
  801ab3:	00 
  801ab4:	c7 44 24 08 82 20 80 	movl   $0x802082,0x8(%esp)
  801abb:	00 
  801abc:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801ac3:	00 
  801ac4:	c7 04 24 97 20 80 00 	movl   $0x802097,(%esp)
  801acb:	e8 76 e8 ff ff       	call   800346 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801ad0:	c7 04 24 a4 20 80 00 	movl   $0x8020a4,(%esp)
  801ad7:	e8 5b e9 ff ff       	call   800437 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801adc:	8d 44 24 18          	lea    0x18(%esp),%eax
  801ae0:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ae4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ae8:	89 04 24             	mov    %eax,(%esp)
  801aeb:	e8 d1 ef ff ff       	call   800ac1 <waitpid>
  801af0:	85 c0                	test   %eax,%eax
  801af2:	75 0d                	jne    801b01 <main+0xd1>
  801af4:	8b 54 24 18          	mov    0x18(%esp),%edx
  801af8:	a1 10 30 80 00       	mov    0x803010,%eax
  801afd:	39 c2                	cmp    %eax,%edx
  801aff:	74 24                	je     801b25 <main+0xf5>
  801b01:	c7 44 24 0c c4 20 80 	movl   $0x8020c4,0xc(%esp)
  801b08:	00 
  801b09:	c7 44 24 08 82 20 80 	movl   $0x802082,0x8(%esp)
  801b10:	00 
  801b11:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801b18:	00 
  801b19:	c7 04 24 97 20 80 00 	movl   $0x802097,(%esp)
  801b20:	e8 21 e8 ff ff       	call   800346 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  801b25:	8d 44 24 18          	lea    0x18(%esp),%eax
  801b29:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b2d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b31:	89 04 24             	mov    %eax,(%esp)
  801b34:	e8 88 ef ff ff       	call   800ac1 <waitpid>
  801b39:	85 c0                	test   %eax,%eax
  801b3b:	74 09                	je     801b46 <main+0x116>
  801b3d:	e8 63 ef ff ff       	call   800aa5 <wait>
  801b42:	85 c0                	test   %eax,%eax
  801b44:	75 24                	jne    801b6a <main+0x13a>
  801b46:	c7 44 24 0c f0 20 80 	movl   $0x8020f0,0xc(%esp)
  801b4d:	00 
  801b4e:	c7 44 24 08 82 20 80 	movl   $0x802082,0x8(%esp)
  801b55:	00 
  801b56:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801b5d:	00 
  801b5e:	c7 04 24 97 20 80 00 	movl   $0x802097,(%esp)
  801b65:	e8 dc e7 ff ff       	call   800346 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801b6a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b6e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b72:	c7 04 24 18 21 80 00 	movl   $0x802118,(%esp)
  801b79:	e8 b9 e8 ff ff       	call   800437 <cprintf>

    cprintf("exit pass.\n");
  801b7e:	c7 04 24 28 21 80 00 	movl   $0x802128,(%esp)
  801b85:	e8 ad e8 ff ff       	call   800437 <cprintf>
    return 0;
