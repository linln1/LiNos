...
obj/__user_raceforwhat.out：     文件格式 elf32-i386
...
main(void) {
  ...
  801a36:	83 ec 10             	sub    $0x10,%esp
    listwait();
  801a39:	e8 ee f1 ff ff       	call   800c2c <listwait>
    if(fork()==0)
  ...
  801a53:	eb 05                	jmp    801a5a <main+0x2a>
    }else
    {
    listwait();
  801a55:	e8 d2 f1 ff ff       	call   800c2c <listwait>
     }
    return 0;
