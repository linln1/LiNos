...
main(void) {
  ...
  801a39:	c7 04 24 e0 1f 80 00 	movl   $0x801fe0,(%esp)
  801a40:	e8 f2 e9 ff ff       	call   800437 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801a45:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a4c:	00 
  801a4d:	eb 38                	jmp    801a87 <main+0x57>
        if (bigarray[i] != 0) {
  801a4f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a53:	8b 04 85 60 31 80 00 	mov    0x803160(,%eax,4),%eax
  801a5a:	85 c0                	test   %eax,%eax
  801a5c:	74 24                	je     801a82 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  801a5e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a62:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801a66:	c7 44 24 08 00 20 80 	movl   $0x802000,0x8(%esp)
  801a6d:	00 
  801a6e:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801a75:	00 
  801a76:	c7 04 24 1d 20 80 00 	movl   $0x80201d,(%esp)
  801a7d:	e8 c4 e8 ff ff       	call   800346 <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801a82:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a87:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801a8e:	00 
  801a8f:	7e be                	jle    801a4f <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801a91:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a98:	00 
  801a99:	eb 14                	jmp    801aaf <main+0x7f>
        bigarray[i] = i;
  801a9b:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801a9f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801aa3:	89 14 85 60 31 80 00 	mov    %edx,0x803160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801aaa:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801aaf:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801ab6:	00 
  801ab7:	7e e2                	jle    801a9b <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801ab9:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801ac0:	00 
  801ac1:	eb 3c                	jmp    801aff <main+0xcf>
        if (bigarray[i] != i) {
  801ac3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ac7:	8b 14 85 60 31 80 00 	mov    0x803160(,%eax,4),%edx
  801ace:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ad2:	39 c2                	cmp    %eax,%edx
  801ad4:	74 24                	je     801afa <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801ad6:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ada:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801ade:	c7 44 24 08 2c 20 80 	movl   $0x80202c,0x8(%esp)
  801ae5:	00 
  801ae6:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  801aed:	00 
  801aee:	c7 04 24 1d 20 80 00 	movl   $0x80201d,(%esp)
  801af5:	e8 4c e8 ff ff       	call   800346 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801afa:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801aff:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801b06:	00 
  801b07:	7e ba                	jle    801ac3 <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  801b09:	c7 04 24 54 20 80 00 	movl   $0x802054,(%esp)
  801b10:	e8 22 e9 ff ff       	call   800437 <cprintf>
    cprintf("testbss may pass.\n");
  801b15:	c7 04 24 87 20 80 00 	movl   $0x802087,(%esp)
  801b1c:	e8 16 e9 ff ff       	call   800437 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  801b21:	c7 05 60 41 c0 00 00 	movl   $0x0,0xc04160
  801b28:	00 00 00 
    asm volatile ("int $0x14");
  801b2b:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  801b2d:	c7 44 24 08 9a 20 80 	movl   $0x80209a,0x8(%esp)
  801b34:	00 
  801b35:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  801b3c:	00 
  801b3d:	c7 04 24 1d 20 80 00 	movl   $0x80201d,(%esp)
  801b44:	e8 fd e7 ff ff       	call   800346 <__panic>
