...
obj/__user_open.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 00 1c 80 00 	movl   $0x801c00,(%esp)
  ...
  8002de:	c7 04 24 0b 1c 80 00 	movl   $0x801c0b,(%esp)
  ...
  8002f4:	c7 04 24 1d 1c 80 00 	movl   $0x801c1d,(%esp)
  ...
  80030a:	c7 04 24 30 1c 80 00 	movl   $0x801c30,(%esp)
  ...
  800320:	c7 04 24 43 1c 80 00 	movl   $0x801c43,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 56 1c 80 00 	movl   $0x801c56,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 70 1c 80 00 	movl   $0x801c70,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 72 1c 80 00 	movl   $0x801c72,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 70 1c 80 00 	movl   $0x801c70,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 8e 1c 80 00 	movl   $0x801c8e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 a1 1c 80 	movl   $0x801ca1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 a8 1c 80 	movl   $0x801ca8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 c2 1c 80 00 	movl   $0x801cc2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 d4 1c 80 	movl   $0x801cd4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 dc 1c 80 	movl   $0x801cdc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 c2 1c 80 00 	movl   $0x801cc2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 04 1f 80 00       	add    $0x801f04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 28 1f 80 00 	mov    0x801f28(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 1e 1f 80 	movl   $0x801f1e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 21 1f 80 00       	mov    $0x801f21,%esi
            }
            if (width > 0 && padc != '-') {
...
static int safe_open(const char *path, int open_flags)
{
  ...
  801a52:	c7 44 24 04 80 20 80 	movl   $0x802080,0x4(%esp)
  801a59:	00 
  ...
  801a6c:	c7 44 24 0c 8a 20 80 	movl   $0x80208a,0xc(%esp)
  801a73:	00 
  801a74:	c7 44 24 08 92 20 80 	movl   $0x802092,0x8(%esp)
  801a7b:	00 
  801a7c:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801a83:	00 
  801a84:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
...
static struct stat *safe_fstat(int fd)
{
  ...
  801ab8:	c7 44 24 0c b3 20 80 	movl   $0x8020b3,0xc(%esp)
  801abf:	00 
  801ac0:	c7 44 24 08 92 20 80 	movl   $0x802092,0x8(%esp)
  801ac7:	00 
  801ac8:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801acf:	00 
  801ad0:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
...
static void safe_read(int fd, void *data, size_t len)
{
  ...
  801b0d:	c7 44 24 0c bc 20 80 	movl   $0x8020bc,0xc(%esp)
  801b14:	00 
  801b15:	c7 44 24 08 92 20 80 	movl   $0x802092,0x8(%esp)
  801b1c:	00 
  801b1d:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  801b24:	00 
  801b25:	c7 04 24 a7 20 80 00 	movl   $0x8020a7,(%esp)
...
int main(int argc, char** argv)
{
  ...
  801b39:	83 ec 60             	sub    $0x60,%esp
	if(argc != 2){
  801b3c:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801b40:	74 14                	je     801b56 <main+0x23>
		printf("[error] : wrong number of params! \n");	
  801b42:	c7 44 24 04 c8 20 80 	movl   $0x8020c8,0x4(%esp)
  801b49:	00 
  801b4a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b51:	e8 c5 e9 ff ff       	call   80051b <fprintf>
	}
	int fd1 = safe_open(argv[1], O_RDONLY);
  801b56:	8b 45 0c             	mov    0xc(%ebp),%eax
  801b59:	83 c0 04             	add    $0x4,%eax
  801b5c:	8b 00                	mov    (%eax),%eax
  801b5e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801b65:	00 
  801b66:	89 04 24             	mov    %eax,(%esp)
  801b69:	e8 c2 fe ff ff       	call   801a30 <safe_open>
  801b6e:	89 44 24 5c          	mov    %eax,0x5c(%esp)
	struct stat *stat = safe_fstat(fd1);
  801b72:	8b 44 24 5c          	mov    0x5c(%esp),%eax
  801b76:	89 04 24             	mov    %eax,(%esp)
  801b79:	e8 17 ff ff ff       	call   801a95 <safe_fstat>
  801b7e:	89 44 24 58          	mov    %eax,0x58(%esp)
	assert(stat->st_size >= 0 && stat->st_blocks >= 0);
	printf("file %s pass.\n", argv[1]);
  801b82:	8b 45 0c             	mov    0xc(%ebp),%eax
  801b85:	83 c0 04             	add    $0x4,%eax
  801b88:	8b 00                	mov    (%eax),%eax
  801b8a:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b8e:	c7 44 24 04 ec 20 80 	movl   $0x8020ec,0x4(%esp)
  801b95:	00 
  801b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b9d:	e8 79 e9 ff ff       	call   80051b <fprintf>

	char filename[64];
	getcwd(&filename, 30);
  801ba2:	c7 44 24 04 1e 00 00 	movl   $0x1e,0x4(%esp)
  801ba9:	00 
  801baa:	8d 44 24 18          	lea    0x18(%esp),%eax
  801bae:	89 04 24             	mov    %eax,(%esp)
  801bb1:	e8 3b e5 ff ff       	call   8000f1 <getcwd>
	printf("cwd = %s\n", filename);
  801bb6:	8d 44 24 18          	lea    0x18(%esp),%eax
  801bba:	89 44 24 08          	mov    %eax,0x8(%esp)
  801bbe:	c7 44 24 04 fb 20 80 	movl   $0x8020fb,0x4(%esp)
  801bc5:	00 
  801bc6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801bcd:	e8 49 e9 ff ff       	call   80051b <fprintf>

	close(fd1);
  801bd2:	8b 44 24 5c          	mov    0x5c(%esp),%eax
  801bd6:	89 04 24             	mov    %eax,(%esp)
  801bd9:	e8 74 e5 ff ff       	call   800152 <close>
	printf("file closed\n");
  801bde:	c7 44 24 04 05 21 80 	movl   $0x802105,0x4(%esp)
  801be5:	00 
  801be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801bed:	e8 29 e9 ff ff       	call   80051b <fprintf>
