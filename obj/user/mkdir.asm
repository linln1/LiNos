...
obj/__user_mkdir.out：     文件格式 elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 20 1b 80 00 	movl   $0x801b20,(%esp)
  ...
  8002de:	c7 04 24 2b 1b 80 00 	movl   $0x801b2b,(%esp)
  ...
  8002f4:	c7 04 24 3d 1b 80 00 	movl   $0x801b3d,(%esp)
  ...
  80030a:	c7 04 24 50 1b 80 00 	movl   $0x801b50,(%esp)
  ...
  800320:	c7 04 24 63 1b 80 00 	movl   $0x801b63,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 76 1b 80 00 	movl   $0x801b76,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 90 1b 80 00 	movl   $0x801b90,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 92 1b 80 00 	movl   $0x801b92,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 90 1b 80 00 	movl   $0x801b90,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ae 1b 80 00 	movl   $0x801bae,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 c1 1b 80 	movl   $0x801bc1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 c8 1b 80 	movl   $0x801bc8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 e2 1b 80 00 	movl   $0x801be2,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 f4 1b 80 	movl   $0x801bf4,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 fc 1b 80 	movl   $0x801bfc,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 e2 1b 80 00 	movl   $0x801be2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 24 1e 80 00       	add    $0x801e24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 48 1e 80 00 	mov    0x801e48(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 3e 1e 80 	movl   $0x801e3e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 41 1e 80 00       	mov    $0x801e41,%esi
            }
            if (width > 0 && padc != '-') {
...
{	
  ...
  801a36:	81 ec 20 01 00 00    	sub    $0x120,%esp
	
	if(argc != 2){
  801a3c:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801a40:	74 1e                	je     801a60 <main+0x30>
		printf("[error] : wrong number of params! \n");	
  801a42:	c7 44 24 04 a0 1f 80 	movl   $0x801fa0,0x4(%esp)
  801a49:	00 
  801a4a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a51:	e8 c5 ea ff ff       	call   80051b <fprintf>
		return -1;
  801a56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a5b:	e9 b6 00 00 00       	jmp    801b16 <main+0xe6>
	}
	char *dir_name = argv[1];
  801a60:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a63:	8b 40 04             	mov    0x4(%eax),%eax
  801a66:	89 84 24 18 01 00 00 	mov    %eax,0x118(%esp)
        char path[256];
        int i;
        for(i = 0 ; i < 256 && dir_name[i] != '\0'; i++){
  801a6d:	c7 84 24 1c 01 00 00 	movl   $0x0,0x11c(%esp)
  801a74:	00 00 00 00 
  801a78:	eb 2a                	jmp    801aa4 <main+0x74>
        	path[i] = dir_name[i];
  801a7a:	8b 94 24 1c 01 00 00 	mov    0x11c(%esp),%edx
  801a81:	8b 84 24 18 01 00 00 	mov    0x118(%esp),%eax
  801a88:	01 d0                	add    %edx,%eax
  801a8a:	0f b6 00             	movzbl (%eax),%eax
  801a8d:	8d 4c 24 14          	lea    0x14(%esp),%ecx
  801a91:	8b 94 24 1c 01 00 00 	mov    0x11c(%esp),%edx
  801a98:	01 ca                	add    %ecx,%edx
  801a9a:	88 02                	mov    %al,(%edx)
	...
	char *dir_name = argv[1];
        ...
        int i;
        for(i = 0 ; i < 256 && dir_name[i] != '\0'; i++){
  801a9c:	83 84 24 1c 01 00 00 	addl   $0x1,0x11c(%esp)
  801aa3:	01 
  801aa4:	81 bc 24 1c 01 00 00 	cmpl   $0xff,0x11c(%esp)
  801aab:	ff 00 00 00 
  801aaf:	7f 17                	jg     801ac8 <main+0x98>
  801ab1:	8b 94 24 1c 01 00 00 	mov    0x11c(%esp),%edx
  801ab8:	8b 84 24 18 01 00 00 	mov    0x118(%esp),%eax
  801abf:	01 d0                	add    %edx,%eax
  801ac1:	0f b6 00             	movzbl (%eax),%eax
  801ac4:	84 c0                	test   %al,%al
  801ac6:	75 b2                	jne    801a7a <main+0x4a>
        	path[i] = dir_name[i];
        }
	path[i] = '\0';
  801ac8:	8d 54 24 14          	lea    0x14(%esp),%edx
  801acc:	8b 84 24 1c 01 00 00 	mov    0x11c(%esp),%eax
  801ad3:	01 d0                	add    %edx,%eax
  801ad5:	c6 00 00             	movb   $0x0,(%eax)
	int ret = mkdir(path);
  801ad8:	8d 44 24 14          	lea    0x14(%esp),%eax
  801adc:	89 04 24             	mov    %eax,(%esp)
  801adf:	e8 fa e5 ff ff       	call   8000de <mkdir>
  801ae4:	89 84 24 14 01 00 00 	mov    %eax,0x114(%esp)
	if(ret == 0) {
  801aeb:	83 bc 24 14 01 00 00 	cmpl   $0x0,0x114(%esp)
  801af2:	00 
  801af3:	75 1c                	jne    801b11 <main+0xe1>
		printf("dir %s created successful!\n", path);
  801af5:	8d 44 24 14          	lea    0x14(%esp),%eax
  801af9:	89 44 24 08          	mov    %eax,0x8(%esp)
  801afd:	c7 44 24 04 c4 1f 80 	movl   $0x801fc4,0x4(%esp)
  801b04:	00 
  801b05:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b0c:	e8 0a ea ff ff       	call   80051b <fprintf>
	}
	return 0;
