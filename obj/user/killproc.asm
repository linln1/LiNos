...
obj/__user_killproc.out：     文件格式 elf32-i386
...
main(void) {
  ...
  801a39:	e8 6d f1 ff ff       	call   800bab <listProc>
    int pid=fork();
  801a3e:	e8 55 f0 ff ff       	call   800a98 <fork>
  801a43:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    if(pid==0)
  801a47:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801a4c:	75 16                	jne    801a64 <main+0x34>
    {
     cprintf("%d",pid);
  801a4e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a52:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a56:	c7 04 24 40 1f 80 00 	movl   $0x801f40,(%esp)
  801a5d:	e8 d5 e9 ff ff       	call   800437 <cprintf>
  801a62:	eb 36                	jmp    801a9a <main+0x6a>
    }else
    {cprintf("------\n");
  801a64:	c7 04 24 43 1f 80 00 	movl   $0x801f43,(%esp)
  801a6b:	e8 c7 e9 ff ff       	call   800437 <cprintf>
    listProc();
  801a70:	e8 36 f1 ff ff       	call   800bab <listProc>
    kill(pid);
  801a75:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a79:	89 04 24             	mov    %eax,(%esp)
  801a7c:	e8 67 f0 ff ff       	call   800ae8 <kill>
    cprintf("delete process %d",pid);
  801a81:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a85:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a89:	c7 04 24 4b 1f 80 00 	movl   $0x801f4b,(%esp)
  801a90:	e8 a2 e9 ff ff       	call   800437 <cprintf>
    listProc();
  801a95:	e8 11 f1 ff ff       	call   800bab <listProc>
