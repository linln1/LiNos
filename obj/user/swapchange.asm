...
obj/__user_swapchange.out：     文件格式 elf32-i386
...
main(int argc, char **argv){
  ...
  801a3d:	74 16                	je     801a55 <main+0x25>
        printf("\nbad argument!\n");
  801a3f:	c7 44 24 04 60 1f 80 	movl   $0x801f60,0x4(%esp)
  801a46:	00 
  801a47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a4e:	e8 c8 ea ff ff       	call   80051b <fprintf>
  801a53:	eb 6b                	jmp    801ac0 <main+0x90>
    }
    else{
    	if(argv[1][0]=='1')
  801a55:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a58:	83 c0 04             	add    $0x4,%eax
  801a5b:	8b 00                	mov    (%eax),%eax
  801a5d:	0f b6 00             	movzbl (%eax),%eax
  801a60:	3c 31                	cmp    $0x31,%al
  801a62:	75 0e                	jne    801a72 <main+0x42>
    	    change_swap(1);
  801a64:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a6b:	e8 89 f1 ff ff       	call   800bf9 <change_swap>
  801a70:	eb 4e                	jmp    801ac0 <main+0x90>
    	else if(argv[1][0]=='2')	
  801a72:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a75:	83 c0 04             	add    $0x4,%eax
  801a78:	8b 00                	mov    (%eax),%eax
  801a7a:	0f b6 00             	movzbl (%eax),%eax
  801a7d:	3c 32                	cmp    $0x32,%al
  801a7f:	75 0e                	jne    801a8f <main+0x5f>
            change_swap(2);
  801a81:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  801a88:	e8 6c f1 ff ff       	call   800bf9 <change_swap>
  801a8d:	eb 31                	jmp    801ac0 <main+0x90>
        else if(argv[1][0]=='3')	
  801a8f:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a92:	83 c0 04             	add    $0x4,%eax
  801a95:	8b 00                	mov    (%eax),%eax
  801a97:	0f b6 00             	movzbl (%eax),%eax
  801a9a:	3c 33                	cmp    $0x33,%al
  801a9c:	75 0e                	jne    801aac <main+0x7c>
            change_swap(3);
  801a9e:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  801aa5:	e8 4f f1 ff ff       	call   800bf9 <change_swap>
  801aaa:	eb 14                	jmp    801ac0 <main+0x90>
        else
            printf("\nbad argument!\n");
  801aac:	c7 44 24 04 60 1f 80 	movl   $0x801f60,0x4(%esp)
  801ab3:	00 
  801ab4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801abb:	e8 5b ea ff ff       	call   80051b <fprintf>
    }
    return 0;
