...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 40 1d 80 00 	movl   $0x801d40,(%esp)
  ...
  8002de:	c7 04 24 4b 1d 80 00 	movl   $0x801d4b,(%esp)
  ...
  8002f4:	c7 04 24 5d 1d 80 00 	movl   $0x801d5d,(%esp)
  ...
  80030a:	c7 04 24 70 1d 80 00 	movl   $0x801d70,(%esp)
  ...
  800320:	c7 04 24 83 1d 80 00 	movl   $0x801d83,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 96 1d 80 00 	movl   $0x801d96,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 b2 1d 80 00 	movl   $0x801db2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 b0 1d 80 00 	movl   $0x801db0,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ce 1d 80 00 	movl   $0x801dce,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 e1 1d 80 	movl   $0x801de1,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 e8 1d 80 	movl   $0x801de8,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 02 1e 80 00 	movl   $0x801e02,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 14 1e 80 	movl   $0x801e14,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 1c 1e 80 	movl   $0x801e1c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 02 1e 80 00 	movl   $0x801e02,(%esp)
  ...
  800d3a:	e8 1d 0d 00 00       	call   801a5c <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 44 20 80 00       	add    $0x802044,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 68 20 80 00 	mov    0x802068(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 5e 20 80 	movl   $0x80205e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 61 20 80 00       	mov    $0x802061,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  801a3d:	eb 12                	jmp    801a51 <spin_delay+0x21>
     {
          j = !j;
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  801a4d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  801a51:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  801a58:	75 e5                	jne    801a3f <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  801a5f:	56                   	push   %esi
  801a60:	53                   	push   %ebx
  801a61:	83 e4 f0             	and    $0xfffffff0,%esp
  801a64:	83 ec 20             	sub    $0x20,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  801a67:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801a6e:	00 
  801a6f:	c7 04 24 c0 21 80 00 	movl   $0x8021c0,(%esp)
  801a76:	e8 bc e9 ff ff       	call   800437 <cprintf>
     sleep(SLEEP_TIME);
  801a7b:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801a82:	e8 a1 f0 ff ff       	call   800b28 <sleep>
     memset(pids, 0, sizeof(pids));
  801a87:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801a8e:	00 
  801a8f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801a96:	00 
  801a97:	c7 04 24 70 31 80 00 	movl   $0x803170,(%esp)
  801a9e:	e8 04 fe ff ff       	call   8018a7 <memset>
     lab6_set_priority(TOTAL + 1);
  801aa3:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801aaa:	e8 66 f0 ff ff       	call   800b15 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801aaf:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801ab6:	00 
  801ab7:	e9 0e 01 00 00       	jmp    801bca <main+0x16e>
          acc[i]=0;
  801abc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ac0:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801ac7:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801acb:	e8 c8 ef ff ff       	call   800a98 <fork>
  801ad0:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801ad4:	89 04 95 70 31 80 00 	mov    %eax,0x803170(,%edx,4)
  801adb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801adf:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801ae6:	85 c0                	test   %eax,%eax
  801ae8:	0f 85 ba 00 00 00    	jne    801ba8 <main+0x14c>
               lab6_set_priority(i + 1);
  801aee:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801af2:	83 c0 01             	add    $0x1,%eax
  801af5:	89 04 24             	mov    %eax,(%esp)
  801af8:	e8 18 f0 ff ff       	call   800b15 <lab6_set_priority>
               acc[i] = 0;
  801afd:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b01:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801b08:	00 00 00 00 
               while (1) {
                    spin_delay();
  801b0c:	e8 1f ff ff ff       	call   801a30 <spin_delay>
                    ++ acc[i];
  801b11:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b15:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801b1c:	8d 50 01             	lea    0x1(%eax),%edx
  801b1f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b23:	89 14 85 48 31 80 00 	mov    %edx,0x803148(,%eax,4)
                    if(acc[i]%4000==0) {
  801b2a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b2e:	8b 0c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ecx
  801b35:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  801b3a:	89 c8                	mov    %ecx,%eax
  801b3c:	f7 e2                	mul    %edx
  801b3e:	89 d0                	mov    %edx,%eax
  801b40:	c1 e8 08             	shr    $0x8,%eax
  801b43:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  801b49:	29 c1                	sub    %eax,%ecx
  801b4b:	89 c8                	mov    %ecx,%eax
  801b4d:	85 c0                	test   %eax,%eax
  801b4f:	75 52                	jne    801ba3 <main+0x147>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  801b51:	e8 e5 ef ff ff       	call   800b3b <gettime_msec>
  801b56:	89 44 24 18          	mov    %eax,0x18(%esp)
  801b5a:	81 7c 24 18 78 05 00 	cmpl   $0x578,0x18(%esp)
  801b61:	00 
  801b62:	7e 3f                	jle    801ba3 <main+0x147>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801b64:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b68:	8b 1c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ebx
  801b6f:	e8 87 ef ff ff       	call   800afb <getpid>
  801b74:	8b 54 24 18          	mov    0x18(%esp),%edx
  801b78:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801b7c:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801b80:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b84:	c7 04 24 e8 21 80 00 	movl   $0x8021e8,(%esp)
  801b8b:	e8 a7 e8 ff ff       	call   800437 <cprintf>
                            exit(acc[i]);
  801b90:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b94:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801b9b:	89 04 24             	mov    %eax,(%esp)
  801b9e:	e8 d6 ee ff ff       	call   800a79 <exit>
                        }
                    }
               }
  801ba3:	e9 64 ff ff ff       	jmp    801b0c <main+0xb0>
               
          }
          if (pids[i] < 0) {
  801ba8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801bac:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801bb3:	85 c0                	test   %eax,%eax
  801bb5:	79 0e                	jns    801bc5 <main+0x169>
               goto failed;
  801bb7:	90                   	nop
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801bb8:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801bbf:	00 
  801bc0:	e9 32 01 00 00       	jmp    801cf7 <main+0x29b>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  801bc5:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801bca:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801bcf:	0f 8e e7 fe ff ff    	jle    801abc <main+0x60>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  801bd5:	c7 04 24 08 22 80 00 	movl   $0x802208,(%esp)
  801bdc:	e8 56 e8 ff ff       	call   800437 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  801be1:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801be8:	00 
  801be9:	eb 6b                	jmp    801c56 <main+0x1fa>
         status[i]=0;
  801beb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801bef:	c7 04 85 5c 31 80 00 	movl   $0x0,0x80315c(,%eax,4)
  801bf6:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  801bfa:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801bfe:	c1 e0 02             	shl    $0x2,%eax
  801c01:	8d 90 5c 31 80 00    	lea    0x80315c(%eax),%edx
  801c07:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801c0b:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801c12:	89 54 24 04          	mov    %edx,0x4(%esp)
  801c16:	89 04 24             	mov    %eax,(%esp)
  801c19:	e8 a3 ee ff ff       	call   800ac1 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  801c1e:	e8 18 ef ff ff       	call   800b3b <gettime_msec>
  801c23:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801c27:	8b 0c 95 5c 31 80 00 	mov    0x80315c(,%edx,4),%ecx
  801c2e:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801c32:	8b 14 95 70 31 80 00 	mov    0x803170(,%edx,4),%edx
  801c39:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801c3d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801c41:	89 54 24 04          	mov    %edx,0x4(%esp)
  801c45:	c7 04 24 30 22 80 00 	movl   $0x802230,(%esp)
  801c4c:	e8 e6 e7 ff ff       	call   800437 <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  801c51:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801c56:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801c5b:	7e 8e                	jle    801beb <main+0x18f>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  801c5d:	c7 04 24 4f 22 80 00 	movl   $0x80224f,(%esp)
  801c64:	e8 ce e7 ff ff       	call   800437 <cprintf>
     cprintf("stride sched correct result:");
  801c69:	c7 04 24 65 22 80 00 	movl   $0x802265,(%esp)
  801c70:	e8 c2 e7 ff ff       	call   800437 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801c75:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801c7c:	00 
  801c7d:	eb 37                	jmp    801cb6 <main+0x25a>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801c7f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801c83:	8b 04 85 5c 31 80 00 	mov    0x80315c(,%eax,4),%eax
  801c8a:	01 c0                	add    %eax,%eax
  801c8c:	8b 35 5c 31 80 00    	mov    0x80315c,%esi
  801c92:	99                   	cltd   
  801c93:	f7 fe                	idiv   %esi
  801c95:	83 c0 01             	add    $0x1,%eax
  801c98:	89 c2                	mov    %eax,%edx
  801c9a:	c1 ea 1f             	shr    $0x1f,%edx
  801c9d:	01 d0                	add    %edx,%eax
  801c9f:	d1 f8                	sar    %eax
  801ca1:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ca5:	c7 04 24 82 22 80 00 	movl   $0x802282,(%esp)
  801cac:	e8 86 e7 ff ff       	call   800437 <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801cb1:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801cb6:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801cbb:	7e c2                	jle    801c7f <main+0x223>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801cbd:	c7 04 24 86 22 80 00 	movl   $0x802286,(%esp)
  801cc4:	e8 6e e7 ff ff       	call   800437 <cprintf>

     return 0;
  801cc9:	b8 00 00 00 00       	mov    $0x0,%eax
  801cce:	eb 4a                	jmp    801d1a <main+0x2be>

failed:
     for (i = 0; i < TOTAL; i ++) {
          if (pids[i] > 0) {
  801cd0:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801cd4:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801cdb:	85 c0                	test   %eax,%eax
  801cdd:	7e 13                	jle    801cf2 <main+0x296>
               kill(pids[i]);
  801cdf:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801ce3:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801cea:	89 04 24             	mov    %eax,(%esp)
  801ced:	e8 f6 ed ff ff       	call   800ae8 <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801cf2:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801cf7:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801cfc:	7e d2                	jle    801cd0 <main+0x274>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  801cfe:	c7 44 24 08 88 22 80 	movl   $0x802288,0x8(%esp)
  801d05:	00 
  801d06:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801d0d:	00 
  801d0e:	c7 04 24 93 22 80 00 	movl   $0x802293,(%esp)
  801d15:	e8 2c e6 ff ff       	call   800346 <__panic>
}
