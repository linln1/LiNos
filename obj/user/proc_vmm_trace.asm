...
obj/__user_proc_vmm_trace.outÔºö     Êñá‰ª∂Ê†ºÂºè elf32-i386
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  8002c0:	c7 04 24 60 1b 80 00 	movl   $0x801b60,(%esp)
  ...
  8002de:	c7 04 24 6b 1b 80 00 	movl   $0x801b6b,(%esp)
  ...
  8002f4:	c7 04 24 7d 1b 80 00 	movl   $0x801b7d,(%esp)
  ...
  80030a:	c7 04 24 90 1b 80 00 	movl   $0x801b90,(%esp)
  ...
  800320:	c7 04 24 a3 1b 80 00 	movl   $0x801ba3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800360:	c7 04 24 b6 1b 80 00 	movl   $0x801bb6,(%esp)
  ...
  800379:	e8 7e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  80037e:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8003b0:	c7 04 24 d2 1b 80 00 	movl   $0x801bd2,(%esp)
  ...
  8003c9:	e8 2e 00 00 00       	call   8003fc <vcprintf>
    cprintf("\n");
  8003ce:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
...
exit(int error_code) {
  ...
  800a8a:	c7 04 24 ee 1b 80 00 	movl   $0x801bee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800ca4:	00 
  800ca5:	c7 44 24 04 01 1c 80 	movl   $0x801c01,0x4(%esp)
  800cac:	00 
  ...
  800cc9:	c7 44 24 08 08 1c 80 	movl   $0x801c08,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 22 1c 80 00 	movl   $0x801c22,(%esp)
  800ce0:	e8 b1 f6 ff ff       	call   800396 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800ce5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800cec:	00 
  800ced:	c7 44 24 04 34 1c 80 	movl   $0x801c34,0x4(%esp)
  800cf4:	00 
  ...
  800d11:	c7 44 24 08 3c 1c 80 	movl   $0x801c3c,0x8(%esp)
  800d18:	00 
  800d19:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800d20:	00 
  800d21:	c7 04 24 22 1c 80 00 	movl   $0x801c22,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800e69:	05 64 1e 80 00       	add    $0x801e64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800fcd:	8b 04 85 88 1e 80 00 	mov    0x801e88(,%eax,4),%eax
  ...
  8010e6:	c7 44 24 0c 7e 1e 80 	movl   $0x801e7e,0xc(%esp)
  8010ed:	00 
  ...
  801119:	75 05                	jne    801120 <vprintfmt+0x1c9>
                p = "(null)";
  80111b:	be 81 1e 80 00       	mov    $0x801e81,%esi
            }
            if (width > 0 && padc != '-') {
...
// ≥ı ºŒ™¡Ω∏ˆƒ⁄∫Àœﬂ≥Ã£¨±æ≥Ã–ÚŒ™µ⁄3∫≈œﬂ≥Ã£¨fork()≥ˆ¿¥µƒŒ™4∫≈œﬂ≥Ã£¨‘⁄4∫≈œﬂ≥Ã÷–…Í«Îƒ⁄¥Êø’º‰Õ¨ ±‘⁄»˝∫≈œﬂ≥Ã÷–π€≤‚œµÕ≥÷–À˘”–Ω¯≥Ãƒ⁄¥Êø’º‰µƒ±‰ªØ£¨÷˜“™π€≤‚Àƒ∫≈Ω¯≥Ãµƒƒ⁄¥Ê±‰ªØ 
//¥Àπ˝≥Ã‘⁄»˝∫≈Ω¯≥Ã÷– ‰≥ˆ¡À¡Àfork()≥ˆµƒÀƒ∫≈Ω¯≥Ã¥”≥ˆ…˙µΩÀ¿µƒ»´≤øƒ⁄¥Ê±‰ªØ«Èøˆ
int main(){
  801a30:	55                   	push   %ebp
  801a31:	89 e5                	mov    %esp,%ebp
  801a33:	83 e4 f0             	and    $0xfffffff0,%esp
  801a36:	83 ec 30             	sub    $0x30,%esp
        
        listProc();
  801a39:	e8 6d f1 ff ff       	call   800bab <listProc>
	int seq_num = rand()%15;
  801a3e:	e8 36 fa ff ff       	call   801479 <rand>
  801a43:	89 c1                	mov    %eax,%ecx
  801a45:	ba 89 88 88 88       	mov    $0x88888889,%edx
  801a4a:	89 c8                	mov    %ecx,%eax
  801a4c:	f7 ea                	imul   %edx
  801a4e:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
  801a51:	c1 f8 03             	sar    $0x3,%eax
  ...
  801a5f:	89 44 24 20          	mov    %eax,0x20(%esp)
  801a63:	8b 54 24 20          	mov    0x20(%esp),%edx
  801a67:	89 d0                	mov    %edx,%eax
  801a69:	c1 e0 04             	shl    $0x4,%eax
  801a6c:	29 d0                	sub    %edx,%eax
  801a6e:	29 c1                	sub    %eax,%ecx
  801a70:	89 c8                	mov    %ecx,%eax
  801a72:	89 44 24 20          	mov    %eax,0x20(%esp)
	cprintf("alloc memory for %d times\n", seq_num);
  801a76:	8b 44 24 20          	mov    0x20(%esp),%eax
  801a7a:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a7e:	c7 04 24 e0 1f 80 00 	movl   $0x801fe0,(%esp)
  801a85:	e8 ad e9 ff ff       	call   800437 <cprintf>
        int mem_seq;
        int j=0;
  801a8a:	c7 44 24 28 00 00 00 	movl   $0x0,0x28(%esp)
  801a91:	00 
        int i=0;
  801a92:	c7 44 24 24 00 00 00 	movl   $0x0,0x24(%esp)
  801a99:	00 
	int ret = 0;
  801a9a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801aa1:	00 
       if(fork()==0){
  801aa2:	e8 f1 ef ff ff       	call   800a98 <fork>
  801aa7:	85 c0                	test   %eax,%eax
  801aa9:	75 63                	jne    801b0e <main+0xde>
	for(; i < seq_num; i++){
  801aab:	eb 55                	jmp    801b02 <main+0xd2>
		mem_seq = rand();
  801aad:	e8 c7 f9 ff ff       	call   801479 <rand>
  801ab2:	89 44 24 2c          	mov    %eax,0x2c(%esp)
		
		while(mem_seq >= 32*1024 || mem_seq <= 4*1024){
  801ab6:	eb 09                	jmp    801ac1 <main+0x91>
			mem_seq = rand();
  801ab8:	e8 bc f9 ff ff       	call   801479 <rand>
  801abd:	89 44 24 2c          	mov    %eax,0x2c(%esp)
	int ret = 0;
       if(fork()==0){
	for(; i < seq_num; i++){
		mem_seq = rand();
		...
		while(mem_seq >= 32*1024 || mem_seq <= 4*1024){
  801ac1:	81 7c 24 2c ff 7f 00 	cmpl   $0x7fff,0x2c(%esp)
  801ac8:	00 
  801ac9:	7f ed                	jg     801ab8 <main+0x88>
  801acb:	81 7c 24 2c 00 10 00 	cmpl   $0x1000,0x2c(%esp)
  801ad2:	00 
  801ad3:	7e e3                	jle    801ab8 <main+0x88>
			mem_seq = rand();
		}

		cprintf("%d th time, alloc memory about %d\n", i, mem_seq);
  801ad5:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801ad9:	89 44 24 08          	mov    %eax,0x8(%esp)
  801add:	8b 44 24 24          	mov    0x24(%esp),%eax
  801ae1:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ae5:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
  801aec:	e8 46 e9 ff ff       	call   800437 <cprintf>
                malloc(mem_seq);
  801af1:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801af5:	89 04 24             	mov    %eax,(%esp)
  801af8:	e8 8e f0 ff ff       	call   800b8b <malloc>
        int mem_seq;
        int j=0;
        int i=0;
	int ret = 0;
       if(fork()==0){
	for(; i < seq_num; i++){
  801afd:	83 44 24 24 01       	addl   $0x1,0x24(%esp)
  801b02:	8b 44 24 24          	mov    0x24(%esp),%eax
  801b06:	3b 44 24 20          	cmp    0x20(%esp),%eax
  801b0a:	7c a1                	jl     801aad <main+0x7d>
  801b0c:	eb 19                	jmp    801b27 <main+0xf7>
    }else
        {
           ...
           while(j<(seq_num+8))
  801b0e:	eb 0a                	jmp    801b1a <main+0xea>
            {
	   listProc();  
  801b10:	e8 96 f0 ff ff       	call   800bab <listProc>
            j++;
  801b15:	83 44 24 28 01       	addl   $0x1,0x28(%esp)
    }else
        {
           ...
           while(j<(seq_num+8))
  801b1a:	8b 44 24 20          	mov    0x20(%esp),%eax
  801b1e:	83 c0 08             	add    $0x8,%eax
  801b21:	3b 44 24 28          	cmp    0x28(%esp),%eax
  801b25:	7f e9                	jg     801b10 <main+0xe0>
	   listProc();  
            j++;
            }
	...
	cprintf("ret is %d\n", ret);
  801b27:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b2b:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b2f:	c7 04 24 1f 20 80 00 	movl   $0x80201f,(%esp)
  801b36:	e8 fc e8 ff ff       	call   800437 <cprintf>
	return 0;
