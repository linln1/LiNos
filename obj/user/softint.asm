...
main(void) {
  ...
  801a36:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  801a39:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  801a3b:	c7 44 24 08 e0 1e 80 	movl   $0x801ee0,0x8(%esp)
  801a42:	00 
  801a43:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801a4a:	00 
  801a4b:	c7 04 24 eb 1e 80 00 	movl   $0x801eeb,(%esp)
  801a52:	e8 ef e8 ff ff       	call   800346 <__panic>
