...
const struct pmm_manager nextfit_pmm_manager = {
    .name = "nextfit_pmm_manager",
    .init = next_init,
    .init_memmap = next_init_memmap,
    .alloc_pages = next_alloc_pages,
    .free_pages = next_free_pages,
    .nr_free_pages = next_nr_free_pages,
    .check = next_check,
    .user_check = nextfit_user_check,
};
